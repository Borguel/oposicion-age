      ...
      try {
        ...
        if (preguntas.length === 0) {
          ...
          const mensajeAviso = datos.mensaje
            ...
            : `No tienes preguntas favoritas marcadas en tu cuenta. Marca la estrella <span class="icono-inline">${icono("estrella", 14)}</span> durante cualquier test para guardarlas aquí.`;
