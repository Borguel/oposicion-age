...
def _prompt_generacion(anclas, tipo_pregunta, oposicion):
    ...
    system = (
        ...
        "4. La explicación debe justificar la respuesta correcta citando el artículo, indicar "
        "brevemente por qué las otras tres no lo son, usar la terminología oficial de la norma (no "
        "sinónimos) y limitarse al contenido normativo: nunca inventar doctrina ni interpretar la ley.\n"
...
def _prompt_verificacion(pregunta_candidata, anclas):
    ...
    system = (
        ...
        "5. La explicación no coincide exactamente con la respuesta correcta, o no cita el artículo.\n"
