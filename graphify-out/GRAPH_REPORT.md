...
## Corpus Check
- 444 files · ~1,561,802 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8154 nodes · 18680 edges · 353 communities (312 shown, 41 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 432 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `692f9f6f`
...
## Communities (353 total, 41 thin omitted)
...
Cohesion: 0.03
Nodes (71): aa(), addFeatureFlagsHandler(), Bo(), Br, Ca(), captureException(), captureLog(), Ce() (+63 more)

### Community 3 - "ya"
Cohesion: 0.04
Nodes (22): bn(), clearCache(), cn(), critical(), destroy(), error(), flushLogs(), fn() (+14 more)
...
Cohesion: 0.06
Nodes (13): cancelPendingSurvey(), canRenderSurveyAsync(), Ga, getSurveys(), mn(), overrideLinkedFlag(), overrideSampling(), overrideTrigger() (+5 more)
...
### Community 19 - "N"
Cohesion: 0.11
Nodes (3): N(), On, transformToEventProperties()
...
### Community 22 - "test_reparto_realista.py"
Cohesion: 0.14
...
### Community 60 - "q"
Cohesion: 0.06
Nodes (44): s(), l(), allowedMetrics(), Ao, as(), ba, Bs(), Bt() (+36 more)
...
### Community 99 - "test_vigilancia_boe.py"
Cohesion: 0.19
...
### Community 110 - "warn"
Cohesion: 0.07
Nodes (22): dt(), flush(), getAndClearBuffer(), getMessages(), getTickets(), ht, je(), M() (+14 more)
...
### Community 248 - "g"
Cohesion: 0.08
Nodes (30): addExceptionStep(), b(), constructor(), Fo, g(), getAllFeatureFlags(), getFeatureFlag(), getFeatureFlagDetails() (+22 more)
...
### Community 290 - "desactivar_psicotecnicas_incompletas_auxiliar.py"
Cohesion: 0.43
...
### Community 306 - "verificar_bloque_temas_referenciados"
Cohesion: 0.25
...
### Community 333 - "avisos_oficiales_editar"
Cohesion: 0.50
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `concept-seed.mjs`, `zo`, `De`, `warn`, `N`, `al`, `g`, `q`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `pdf_ia.py`, `tarjetas_generator.py`, `utils.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `regenerar_temario_ofimatica.py`, `deepseek_utils.py`, `test_ia.py`, `cargar_examen_oficial_age.py`, `TestGeneracionEnLote`, `_fragmentos_por_lote`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `cargar_temario_boe.py`, `generar_propuesta_cambio`, `cargar_examen_oficial_auxiliar.py`, `cargar_examen_oficial_gace.py`, `generador_preguntas_verificado.py`, `_generar_pregunta_verificada`?**
...
- **Should `posthog-array.js` be split into smaller, more focused modules?**
  _Cohesion score 0.028035982008995503 - nodes in this community are weakly interconnected._