...
## Corpus Check
- 443 files · ~1,559,383 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8141 nodes · 18588 edges · 354 communities (317 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 443 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8ca9e64`
...
Cohesion: 0.08
Nodes (66): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_admin(), requiere_plan(), chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion() (+58 more)

### Community 7 - "admin.py"
Cohesion: 0.04
Nodes (147): analitica_contenido(), auditoria_listar(), avisos_oficiales_actualizar(), avisos_oficiales_crear(), avisos_oficiales_editar(), avisos_oficiales_listar(), _bajas_agregadas(), bajas_listar() (+139 more)

### Community 8 - "utils.py"
Cohesion: 0.05
Nodes (72): obtener_oposicion_solicitada(), Lee sobre qué oposición pide contenido la petición actual (query string…, ordenar_por_prioridad_repaso(), Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, ordenar_por_prioridad_repaso(), Repaso espaciado para favoritas: al no haber un contador de fallos (el usuario…, activar_oposicion(), avisos_oficiales() (+64 more)
...
Cohesion: 0.06
Nodes (59): % de uso MÁS ALTO entre todas las herramientas del usuario en su periodo…, _uso_pico(), _bucket_uso(), cargar_limites_config(), _clave_periodo(), _config_tool(), devolver_uso(), _estructura_defecto() (+51 more)
...
Cohesion: 0.07
Nodes (49): es_dominio_email_desechable(), Dominios de correo desechable/temporal conocidos: una cuenta creada con uno de…, True si el dominio del email está en la lista conocida de correo…, conectar_firestore(), main(), migrar(), Migración única: antes de este cambio existía un plan "gratis" permanente;…, ¿Es ya cliente de pago en ALGUNA oposición (suscripción real, no la prueba… (+41 more)
...
Cohesion: 0.03
Nodes (120): _decodificar_token_admin(), _decodificar_token_peticion(), _permisos_de(), Verifica el token Bearer y devuelve (decoded, None) o (None, respuesta de…, Conjunto de permisos efectivos del token. El super-admin los tiene todos., verify_id_token() con un reintento ante fallos de red al obtener los…, Exige que quien llama tenga AL MENOS UNO de los permisos indicados (o sea…, Header Authorization: Bearer <token> ya verificado -- el dict crudo que… (+112 more)
...
### Community 78 - "_generar_pregunta_verificada"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (34): resolveProjectRoot(), CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveServerPath() (+26 more)

### Community 93 - "generacion_control.py"
Cohesion: 0.19
...
### Community 103 - "listar_documentos"
Cohesion: 0.13
...
### Community 127 - "resolver_tipo_contenido"
Cohesion: 0.22
...
### Community 132 - "captureElementToBlob"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (46): IMPECCABLE_DIR, safeSessionId(), matchesTemplateExtension(), resolveLiveTemplateExtensions(), acceptCli(), acceptReceiptPath(), argVal(), buildAcceptedWrappedSource() (+38 more)
...
### Community 213 - "documentos_pdf.py"
Cohesion: 0.20
...
### Community 235 - "test_webhook_stripe.py"
Cohesion: 0.22
...
### Community 247 - "_recortar_a_bytes_utf8"
Cohesion: 0.27
...
### Community 248 - "buscar_pregunta_banco_ia"
Cohesion: 0.20
...
### Community 250 - "test_vigilancia_boe.py"
Cohesion: 0.22
...
### Community 253 - "obtener_contexto_por_temas_exactos"
Cohesion: 0.23
...
### Community 263 - "detectar_cambios_leyes_vigiladas"
Cohesion: 0.14
...
Cohesion: 0.10
Nodes (40): promocion_publica(), Lectura pública: el frontend decide si mostrarla según el plan del usuario (o…, cancelar_suscripcion(), contactar_soporte(), crear_sesion_checkout(), crear_sesion_portal(), _current_period_end(), eliminar_cuenta() (+32 more)
...
### Community 309 - "obtener_tests_en_progreso_por_documento"
Cohesion: 0.39
...
### Community 314 - "_elegir_ancla_legal"
Cohesion: 0.25
...
### Community 317 - "normalizeGitHubEvent"
Cohesion: 0.38
...
### Community 319 - "eliminar_documento"
Cohesion: 0.43
...
### Community 333 - "syncEditBadgeHitProxies"
Cohesion: 0.27
...
### Community 342 - "expandScanTargets"
Cohesion: 0.53
...
### Community 343 - "migrar_usuarios_premium_existente.py"
Cohesion: 0.60
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `info`, `constructor`, `concept-seed.mjs`, `ka`, `N`, `startIfEnabledOrStop`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `sembrar_usuario_activo()` connect `sembrar_usuario_activo` to `test_admin.py`, `test_repaso_espaciado.py`, `test_verificacion_respuestas_oficiales.py`, `TestCupoMensualDeSubidas`, `test_reconciliar_stripe.py`, `test_generar_test_oficial.py`, `_eventos_sse`, `registro_progreso_usuario.py`, `TestChatPdfMensaje`, `TestDocumentoEstado`, `test_pdf_ia.py`, `_con_sesion`, `TestCosteIaEnHerramientasPdf`, `TestGenerarEsquemaDesdePdf`, `test_temario.py`, `TestSubirDocumento`, `conftest.py`, `test_carpetas_documentos.py`, `_sembrar_tema`?**
