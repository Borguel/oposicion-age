# Graph Report - oposicion-age  (2026-08-27)

## Corpus Check
- 444 files · ~1,561,256 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8154 nodes · 18680 edges · 351 communities (312 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 432 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2e6f18d`
...
- detect-utils.mjs
- cargar_examen_oficial_age.py
- cargar_examen_oficial_auxiliar.py
- animate.md
- Handle `generate`
...
## Communities (351 total, 39 thin omitted)
...
Cohesion: 0.03
Nodes (83): aa(), addFeatureFlagsHandler(), ba, Bo(), Br, Ca(), captureException(), captureLog() (+75 more)
...
### Community 7 - "requiere_admin"
Cohesion: 0.06
Nodes (35): Exige que quien llama sea administrador (custom claim admin:true en su token de…, requiere_admin(), auditoria_listar(), _invalidar_cache_admin_usuarios(), limites_guardar(), limites_obtener(), ranking_demo_borrar(), ranking_demo_estado() (+27 more)

### Community 8 - "utils.py"
Cohesion: 0.04
Nodes (104): _normalizar_pregunta_pdf(), Deja una pregunta cruda de generar_preguntas_ia_en_lotes/…, obtener_oposiciones_disponibles(), _actualizar_memoria_cruzada(), _actualizar_resumen_si_hace_falta(), _bloque_explicar_fallo(), _bloque_respuesta_verificada(), _contexto_personal_usuario() (+96 more)
...
Cohesion: 0.11
Nodes (30): % de uso MÁS ALTO entre todas las herramientas del usuario en su periodo…, _uso_pico(), _elegir_ancla_legal(), _extraer_articulos(), generar_test_verificado(), Trocea el texto verbatim de un subbloque en fragmentos por artículo real. Si no…, Elige 1 (o 2, para 'distincion_articulos') fragmento(s) de artículo real sobre…, Genera hasta num_preguntas preguntas verificadas, repartidas entre 'temas'… (+22 more)

### Community 13 - "live-browser.js"
Cohesion: 0.03
Nodes (137): applyGlobalBarLabelState(), applyParamValue(), applyPlaceholderSizingStyles(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels() (+129 more)

### Community 14 - "test_tu_tutor.py"
Cohesion: 0.05
Nodes (76): agregar_mensaje_a_conversacion(), crear_conversacion(), _es_pregunta_de_test(), _guardar_turno(), _modelo_tutor(), Si chat_id ya existe, usa la oposición con la que se creó ESA conversación (ver…, Compara el mensaje (normalizado, sin acentos) contra el título de cada tema del…, _resolver_oposicion_conversacion() (+68 more)

### Community 15 - ".register"
Cohesion: 0.06
Nodes (15): bn(), cancelPendingSurvey(), _e(), Ga, getFeatureFlag(), getFlags(), isFeatureEnabled(), os() (+7 more)
...
Cohesion: 0.06
Nodes (58): eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), limit, route, Tu Tutor: chat conversacional unificado (antes eran dos herramientas separadas…, Recomendación proactiva para el saludo de bienvenida del chat. Es determinista…, tu_tutor_route() (+50 more)
...
Cohesion: 0.05
Nodes (63): _decodificar_token_admin(), _decodificar_token_peticion(), _permisos_de(), Verifica el token Bearer y devuelve (decoded, None) o (None, respuesta de…, Conjunto de permisos efectivos del token. El super-admin los tiene todos., verify_id_token() con un reintento ante fallos de red al obtener los…, Header Authorization: Bearer <token> ya verificado -- el dict crudo que…, _verificar_id_token() (+55 more)

### Community 24 - "admin.py"
Cohesion: 0.07
Nodes (82): Exige que quien llama tenga AL MENOS UNO de los permisos indicados (o sea…, requiere_permiso(), analitica_contenido(), avisos_oficiales_crear(), avisos_oficiales_listar(), _bajas_agregadas(), bajas_listar(), banco_preguntas_resumen() (+74 more)
...
Cohesion: 0.06
Nodes (40): _generar_documento_validado(), Envoltorio de generar_documento_largo_por_partes que, si el resultado no supera…, acumular_usage(), coste_estimado(), flush_coste(), guardar_coste_directo(), _incrementar_mes(), Contabilidad del gasto en IA (tokens de DeepSeek) por usuario. Cómo funciona: -… (+32 more)
...
Cohesion: 0.04
Nodes (66): obtener_oposicion_solicitada(), Lee sobre qué oposición pide contenido la petición actual (query string…, ordenar_por_prioridad_repaso(), Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, ordenar_por_prioridad_repaso(), Repaso espaciado para favoritas: al no haber un contador de fallos (el usuario…, activar_oposicion(), avisos_oficiales() (+58 more)
...
Cohesion: 0.05
Nodes (75): actualizar_banco_fallos(), listar_fallos(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, desmarcar_favorita(), listar_favoritas(), marcar_favorita(), marcar_repasadas(), Banco persistente de "preguntas favoritas" marcadas por el usuario para repasar… (+67 more)
...
### Community 42 - "cargar_examen_oficial_gace.py"
Cohesion: 0.67
Nodes (3): cargar_examen(), generar_explicacion(), Carga el Primer Ejercicio de una convocatoria GACE (Cuerpo de Gestión de la…
...
Cohesion: 0.13
Nodes (28): enviar_email_activar_oposicion(), enviar_email_aviso_oficial(), enviar_email_bienvenida(), enviar_email_cancelacion_suscripcion(), Correo único al crear la cuenta (ver inicializar_estadisticas_usuario en…, Confirmación de que la baja se ha registrado -- se manda al aceptar /cancelar-…, Aviso para quien se registró pero nunca llegó a activar ninguna oposición: sin…, Aviso de que se ha publicado algo oficial relevante (convocatoria, lista de… (+20 more)
...
### Community 60 - "ka"
Cohesion: 0.07
Nodes (38): s(), l(), as(), Bs(), Bt(), cs(), d(), ds() (+30 more)
...
### Community 62 - "test_vigilancia_boe.py"
Cohesion: 0.19
...
Cohesion: 0.03
Nodes (74): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), anadir_al_banco(), _banco_atascado(), _banco_ref() (+66 more)
...
### Community 69 - "promocion_vigente"
Cohesion: 0.18
...
### Community 71 - "resumen_prueba_cuenta"
Cohesion: 0.11
Nodes (20): _celda_csv_segura(), _filas_ingresos(), ingresos_export(), ingresos_listar(), Neutraliza la inyección de fórmulas CSV (CSV/Formula Injection): Excel/Sheets…, Genera un CSV descargable (UTF-8 con BOM para que Excel respete los acentos)., Todos los usuarios ya decorados (plan efectivo, % de uso, oposiciones…, Descarga todos los usuarios (con los filtros aplicados) en CSV. (+12 more)
...
Cohesion: 0.07
Nodes (59): _clave(), desregistrar(), Control de parada para generaciones en segundo plano (resumen, esquema, test,…, Crea (o reinicia, si por lo que sea quedó uno viejo sin desregistrar) el evento…, Se llama SIEMPRE al terminar (con éxito, con error, o porque se pidió parar) --…, Marca el evento de parada de esta generación, si sigue en curso. Devuelve True…, Marca la parada de TODAS las generaciones en curso de un usuario, sin necesitar…, registrar() (+51 more)
...
### Community 99 - "generador_preguntas_verificado.py"
Cohesion: 0.18
...
Cohesion: 0.15
Nodes (35): cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), clearAnnotations(), clearInsertPicking(), closeTunePopover(), disableInlineEdit(), enterEditingMode() (+27 more)
...
Cohesion: 0.09
Nodes (41): getLegacyLiveSessionsDir(), getLiveSessionsDir(), safeSessionId(), FORBIDDEN, verifyAcceptedFile(), completeCli(), completeThroughServer(), parseArgs() (+33 more)

### Community 127 - "extraer_paginas"
Cohesion: 0.20
Nodes (15): dividir_en_subbloques(), extraer_paginas(), Trocea el texto de una norma en subbloques cortando siempre en límites de…, _ruta_cache_paginas(), _trocear_por_parrafos_o_lineas(), guardar_preview(), main(), procesar_objetivo() (+7 more)
...
Cohesion: 0.06
Nodes (53): ACK_EXTS, ADVISORY_RULES, applyPatchText(), clampByte(), CO_SCAN_STYLE_NAMES, coLocatedStylesheets(), colorIgnoreKey(), DEFAULT_CONFIG (+45 more)
...
Cohesion: 0.09
Nodes (27): _preguntas_stats(), Cuenta preguntas oficiales activas / inactivas / sin explicación., aplicar(), doc_ids(), _firestore_client(), main(), preview(), Desactiva en Firestore las preguntas del banco de GACE que preguntan… (+19 more)
...
Cohesion: 0.14
Nodes (15): _asegurar_tarjeta_valida(), _conceptos_juridicos_citados(), _generar_candidatas_fragmento(), _normalizar(), _parsear_tarjetas(), _prompt_con_exclusion(), _prompt_generacion(), _prompt_verificacion() (+7 more)
...
### Community 176 - "TestGeneracionEnLote"
Cohesion: 0.14
...
Cohesion: 0.10
Nodes (44): IMPECCABLE_DIR, matchesTemplateExtension(), acceptCli(), acceptReceiptPath(), argVal(), buildAcceptedWrappedSource(), buildCarbonizeReplacement(), decodeHtmlAttr() (+36 more)
...
### Community 192 - "preguntas_listar"
Cohesion: 0.25
...
### Community 193 - "podar_temario_gace_bloque2_temas1_5.py"
Cohesion: 0.27
...
Cohesion: 0.17
Nodes (24): appendDesignSystemNote(), bumpEditCount(), clampGroupedToBudget(), dedupeAgainstCache(), depthIsSet(), designSystemOptions(), ensureFile(), ensureSession() (+16 more)

### Community 202 - "cargar_temario_boe.py"
Cohesion: 0.36
Nodes (8): clasificar_subbloque(), construir_subbloques_clasificados(), guardar_preview(), main(), Carga automática de un "Código electrónico" del BOE (una recopilación de leyes…, La sección romana N del SUMARIO (que incluye 'I. INTRODUCCIÓN') es el bloque…, seccion_a_bloque(), subir_a_firestore()

### Community 203 - "firebase_setup.py"
Cohesion: 0.17
Nodes (13): _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking(), route, Clasificación de racha de estudio: anónima y estrictamente opcional. Solo…, Lista de {uid, alias, racha_actual} de todos los apuntados al ranking, ordenada…, salir_ranking() (+5 more)
...
### Community 211 - "desactivar_psicotecnicas_incompletas_auxiliar.py"
Cohesion: 0.43
...
### Community 217 - "filterFindings"
Cohesion: 0.17
Nodes (18): cursorBlockMessage(), clampToBudget(), cleanIgnoreValueDisplay(), directiveFooter(), extractFindingIgnoreValue(), extractFindingIgnoreValueRaw(), extractMotionIgnoreValue(), filterFindings() (+10 more)

### Community 218 - "/assets/plan.js"
Cohesion: 0.18
...
### Community 232 - "verificar_bloque_temas_referenciados"
Cohesion: 0.25
...
### Community 235 - "avisos_oficiales_editar"
Cohesion: 0.50
...
### Community 240 - "cargar_examen_oficial_age.py"
Cohesion: 0.67
Nodes (3): cargar_examen(), generar_explicacion(), Carga el Ejercicio Único de una convocatoria AGE (Cuerpo General Administrativo…

### Community 241 - "cargar_examen_oficial_auxiliar.py"
Cohesion: 0.67
Nodes (3): cargar_examen(), generar_explicacion(), Carga el Ejercicio Único de una convocatoria del Cuerpo General Auxiliar de la…
...
### Community 248 - "g"
Cohesion: 0.10
Nodes (27): addExceptionStep(), b(), constructor(), Fo, g(), getAllFeatureFlags(), getElementSelectors(), getFeatureFlagDetails() (+19 more)

### Community 249 - "Generate Report"
Cohesion: 0.13
Nodes (14): 1. Accessibility (A11y), 2. Performance, 3. Theming, 4. Responsive Design, 5. Implementation Integrity (CRITICAL), Audit Health Score, Detailed Findings by Severity, Diagnostic Scan (+6 more)

### Community 250 - "banco_preguntas_ia.py"
Cohesion: 0.31
...
Cohesion: 0.08
Nodes (44): cuerpo_json_invalido(), demasiadas_peticiones(), estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz() (+36 more)
...
### Community 268 - "staleness-notice.mjs"
Cohesion: 0.38
...
### Community 317 - "browser-script-parts.mjs"
Cohesion: 0.33
...
### Community 330 - "displaySurvey"
Cohesion: 0.33
Nodes (3): canRenderSurvey(), displaySurvey(), renderSurvey()

### Community 333 - "test_guardar_test_con_numeros_del_bug_guarda_suspendido"
Cohesion: 0.67
...
### Community 336 - "validacion_perfil.py"
Cohesion: 0.33
Nodes (5): direccion_valida(), Validación de los datos de perfil que el propio usuario puede escribir…, True si `texto` son solo dígitos y los símbolos habituales de un teléfono (+,…, True si `texto` no supera la longitud máxima y no contiene ningún patrón de…, telefono_valido()

### Community 338 - "banner_obtener"
Cohesion: 0.50
Nodes (4): banner_obtener(), banner_publico(), _leer_banner(), Lectura pública del banner (la usa el frontend en todas las páginas). Solo…

### Community 340 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `concept-seed.mjs`, `De`, `N`, `g`, `es`, `ka`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `pdf_ia.py`, `tarjetas_generator.py`, `utils.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `regenerar_temario_ofimatica.py`, `_generar_pregunta_verificada`, `deepseek_utils.py`, `test_ia.py`, `cargar_examen_oficial_gace.py`, `TestGeneracionEnLote`, `_fragmentos_por_lote`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `cargar_temario_boe.py`, `generar_propuesta_cambio`, `generador_preguntas_verificado.py`, `cargar_examen_oficial_age.py`, `cargar_examen_oficial_auxiliar.py`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `sembrar_usuario_activo()` connect `sembrar_usuario_activo` to `test_admin.py`, `test_repaso_espaciado.py`, `test_verificacion_respuestas_oficiales.py`, `TestCupoMensualDeSubidas`, `test_reconciliar_stripe.py`, `test_generar_test_oficial.py`, `_eventos_sse`, `rutas_progreso.py`, `usuario_autenticado`, `TestChatPdfMensaje`, `TestDocumentoEstado`, `test_pdf_ia.py`, `_con_sesion`, `TestCosteIaEnHerramientasPdf`, `TestGenerarEsquemaDesdePdf`, `test_guardar_test_con_numeros_del_bug_guarda_suspendido`, `test_temario.py`, `TestSubirDocumento`, `conftest.py`, `test_carpetas_documentos.py`, `_sembrar_tema`?**
