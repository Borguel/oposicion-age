...
## Corpus Check
- 444 files · ~1,560,535 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8151 nodes · 18669 edges · 345 communities (308 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 432 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b62e8a21`
...
Cohesion: 0.06
Nodes (60): actualizar_pagina_estatica_avisos(), _cabeceras(), _consultar_avisos_publicados(), _consultar_avisos_publicados_todos(), _escribir_archivo_github(), etiqueta_tipo_aviso(), etiquetas_oposiciones_aviso(), generar_html_avisos() (+52 more)

### Community 6 - "pdf_ia.py"
Cohesion: 0.07
Nodes (62): Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_plan(), chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion(), documento_banco_preguntas(), documento_banco_tarjetas() (+54 more)

### Community 7 - "admin.py"
Cohesion: 0.03
Nodes (159): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que quien llama tenga AL MENOS UNO de los permisos indicados (o sea…, requiere_admin(), requiere_permiso(), analitica_contenido(), auditoria_listar(), avisos_oficiales_actualizar(), avisos_oficiales_crear() (+151 more)

### Community 8 - "test_utils.py"
Cohesion: 0.15
Nodes (22): _normalizar_pregunta_pdf(), Deja una pregunta cruda de generar_preguntas_ia_en_lotes/…, _pregunta_base(), Pruebas de utils.barajar_opciones_pregunta: los LLM tienden a poner la…, test_conserva_las_4_opciones_sin_perder_ni_duplicar_contenido(), test_explicacion_remapeada_a_la_nueva_letra_correcta(), test_no_siempre_deja_la_correcta_en_a(), test_no_toca_explicacion_que_no_sigue_el_formato_por_letra() (+14 more)
...
Cohesion: 0.09
Nodes (50): responder_tutor(), _eventos_sse(), Pruebas de Tu Tutor (chat_controller.responder_tutor + blueprints/tu_tutor.py):…, _sembrar_tema(), test_contexto_de_pagina_pasa_la_pregunta_en_pantalla(), test_contexto_personal_del_usuario_se_incluye_en_el_prompt(), test_contexto_personal_incluye_la_nota_del_ultimo_test(), test_conversacion_normal_si_conserva_el_historial() (+42 more)

### Community 15 - ".register"
Cohesion: 0.06
Nodes (13): ba, cancelPendingSurvey(), canRenderSurveyAsync(), Ga, getSurveys(), ma, overrideLinkedFlag(), overrideSampling() (+5 more)
...
Cohesion: 0.06
Nodes (67): % de uso MÁS ALTO entre todas las herramientas del usuario en su periodo…, _uso_pico(), eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), limit, route, Tu Tutor: chat conversacional unificado (antes eran dos herramientas separadas… (+59 more)
...
### Community 23 - "pagos.py"
Cohesion: 0.04
Nodes (92): _decodificar_token_admin(), _decodificar_token_peticion(), _permisos_de(), Verifica el token Bearer y devuelve (decoded, None) o (None, respuesta de…, Conjunto de permisos efectivos del token. El super-admin los tiene todos., verify_id_token() con un reintento ante fallos de red al obtener los…, Header Authorization: Bearer <token> ya verificado -- el dict crudo que…, requiere_login() (+84 more)

### Community 24 - "warn"
Cohesion: 0.07
Nodes (30): ct(), debug(), dt(), flush(), flushWithTimeout(), ft(), getMessages(), getTickets() (+22 more)
...
### Community 30 - "g"
Cohesion: 0.09
Nodes (34): addExceptionStep(), b(), Ce(), Ee(), Et(), g(), getAllFeatureFlags(), getElementSelectors() (+26 more)
...
Cohesion: 0.05
Nodes (67): obtener_oposicion_solicitada(), Lee sobre qué oposición pide contenido la petición actual (query string…, ordenar_por_prioridad_repaso(), Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, ordenar_por_prioridad_repaso(), Repaso espaciado para favoritas: al no haber un contador de fallos (el usuario…, activar_oposicion(), avisos_oficiales() (+59 more)
...
Cohesion: 0.04
Nodes (93): cuerpo_json_invalido(), demasiadas_peticiones(), estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz() (+85 more)

### Community 37 - "call_deepseek_api"
Cohesion: 0.14
Nodes (30): cargar_examen(), generar_explicacion(), Carga el Ejercicio Único de una convocatoria del Cuerpo General Auxiliar de la…, call_deepseek_api(), Función mejorada para llamar a la API de DeepSeek con mejor manejo de errores.…, Pruebas de deepseek_utils.call_deepseek_api: el modo JSON nativo (nunca usado…, _respuesta_finish_reason(), _respuesta_http_error() (+22 more)
...
Cohesion: 0.08
Nodes (27): cargar_examen(), generar_explicacion(), Carga el Ejercicio Único de una convocatoria AGE (Cuerpo General Administrativo…, cargar_examen(), generar_explicacion(), Carga el Primer Ejercicio de una convocatoria GACE (Cuerpo de Gestión de la…, call_deepseek_api_stream(), _es_error_transitorio() (+19 more)
...
### Community 72 - "firebase_setup.py"
Cohesion: 0.16
Nodes (15): _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking(), route, Clasificación de racha de estudio: anónima y estrictamente opcional. Solo…, Lista de {uid, alias, racha_actual} de todos los apuntados al ranking, ordenada…, salir_ranking() (+7 more)
...
### Community 74 - "ke"
Cohesion: 0.07
Nodes (11): captureLog(), ei, getAndClearBuffer(), ii, je(), ke(), nt(), Oo (+3 more)
...
### Community 78 - "detectar_cambios_leyes_vigiladas"
Cohesion: 0.13
...
Cohesion: 0.23
Nodes (15): _clave_cron_valida(), enviar_recordatorios_activacion(), enviar_recordatorios_prueba(), enviar_recordatorios_racha(), _guardia_diaria(), route, Tareas activadas por un cron externo (GitHub Actions), no por un usuario --…, Avisa por email del final de la prueba gratuita Premium (planes.py): 2 días… (+7 more)
...
Cohesion: 0.23
Nodes (14): _contar_tokens_por_palabras(), Pruebas de utils.obtener_contexto_por_temas_exactos: el RAG de Tu Tutor. Antes…, _sembrar_subbloque(), test_incluye_por_relevancia_no_por_orden_de_almacenamiento(), test_no_truncado_cuando_todo_cabe(), test_sin_mensaje_conserva_el_orden_original_por_id(), test_tras_fragmento_grande_poco_relevante_que_no_cabe_sigue_probando_otros(), TestContarTokens (+6 more)
...
Cohesion: 0.06
Nodes (18): aa(), constructor(), di(), Fo, gs(), hi, isBrowserSupported(), isEnabled() (+10 more)
...
Cohesion: 0.36
Nodes (9): extractFindingIgnoreValue(), filterFindings(), findingMatchesScopedIgnoreFile(), isAdvisoryFinding(), isIgnoredFindingValue(), normalizeIgnoreRule(), normalizeIgnoreValue(), normalizeIgnoreValueEntries() (+1 more)
...
### Community 115 - "info"
Cohesion: 0.10
Nodes (10): al, Bo(), captureException(), Ho(), info(), jo, No(), qo() (+2 more)
...
Cohesion: 0.06
Nodes (54): ACK_EXTS, ADVISORY_RULES, applyPatchText(), clampByte(), clampGroupedToBudget(), clampToBudget(), cleanIgnoreValueDisplay(), CO_SCAN_STYLE_NAMES (+46 more)
...
### Community 132 - "oposiciones.py"
Cohesion: 0.08
Nodes (27): main(), Sube a Firestore los datos oficiales de la convocatoria vigente de una…, cargar(), Carga la prueba psicotécnica (aptitudinal) del Metro de Madrid, convocatoria…, aplicar(), doc_ids(), _firestore_client(), main() (+19 more)
...
Cohesion: 0.20
Nodes (12): _asegurar_tarjeta_valida(), _conceptos_juridicos_citados(), _generar_candidatas_fragmento(), _normalizar(), _prompt_con_exclusion(), _prompt_generacion(), _prompt_verificacion(), Generador de tarjetas de memoria (flashcards) a partir de un PDF subido por el… (+4 more)
...
Cohesion: 0.17
Nodes (24): appendDesignSystemNote(), bumpEditCount(), dedupeAgainstCache(), depthIsSet(), ensureFile(), ensureSession(), findingCacheKey(), isNativePlatform() (+16 more)
...
### Community 218 - "reasignar_temas_examenes.py"
Cohesion: 0.27
...
### Community 235 - "syncEditBadgeHitProxies"
Cohesion: 0.27
Nodes (10): bindEditBadgeProxy(), editBadgeProxyTargets(), initEditBadge(), initEditBadgeHitProxies(), positionEditBadge(), proxyMouseEvent(), setImportantStyle(), styleEditBadgeProxy() (+2 more)

### Community 236 - "instructions.mjs"
Cohesion: 0.40
...
### Community 248 - "source-search.mjs"
Cohesion: 0.32
...
### Community 265 - "promocion_vigente"
Cohesion: 0.23
...
### Community 290 - "migrar_usuarios_premium_existente.py"
Cohesion: 0.60
...
- **Should `test_admin.py` be split into smaller, more focused modules?**
  _Cohesion score 0.025062034739454096 - nodes in this community are weakly interconnected._
