...
## Summary
- 8131 nodes · 18618 edges · 351 communities (312 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `740eb9de`
...
Cohesion: 0.03
Nodes (68): addFeatureFlagsHandler(), Br, Ca(), captureLog(), Ce(), count(), ct(), debug() (+60 more)

### Community 3 - "ya"
Cohesion: 0.05
Nodes (21): clearCache(), cn(), critical(), destroy(), Ea(), error(), flushLogs(), fn() (+13 more)
...
### Community 15 - "Ga"
Cohesion: 0.08
Nodes (6): cancelPendingSurvey(), Ga, qa(), Va, Wa, Wo()
...
Cohesion: 0.07
Nodes (52): eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), limit, route, Tu Tutor: chat conversacional unificado (antes eran dos herramientas separadas…, tu_tutor_route(), tu_tutor_stream_route() (+44 more)
...
### Community 19 - "N"
Cohesion: 0.09
Nodes (9): allowedMetrics(), bn(), flushIntervalMilliseconds(), flushToCaptureTimeoutMs(), N(), On, q(), transformToEventProperties() (+1 more)
...
Cohesion: 0.06
Nodes (57): es_dominio_email_desechable(), Dominios de correo desechable/temporal conocidos: una cuenta creada con uno de…, True si el dominio del email está en la lista conocida de correo…, conectar_firestore(), main(), migrar(), Migración única: antes de este cambio existía un plan "gratis" permanente;…, mejor_plan() (+49 more)

### Community 24 - "test_documentos_pdf.py"
Cohesion: 0.04
Nodes (68): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), _banco_atascado(), buscar_documento_por_texto(), crear_documento() (+60 more)
...
Cohesion: 0.08
Nodes (26): _asegurar_tarjeta_valida(), _conceptos_juridicos_citados(), _contiene_frase_prohibida(), _es_semanticamente_duplicada(), _generar_candidatas_fragmento(), _normalizar(), _normalizar_cifra(), _parsear_tarjetas() (+18 more)
...
Cohesion: 0.05
Nodes (57): actualizar_banco_fallos(), listar_fallos(), ordenar_por_prioridad_repaso(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, desmarcar_favorita(), listar_favoritas(), marcar_favorita() (+49 more)
...
### Community 54 - ".push"
Cohesion: 0.09
Nodes (10): addExceptionStep(), Ae(), De, getElementSelectors(), is(), jo, Se(), si (+2 more)
...
### Community 60 - "ka"
Cohesion: 0.08
Nodes (40): s(), l(), Ao, as(), Bs(), cs(), d(), do() (+32 more)
...
Cohesion: 0.06
Nodes (33): Exige que quien llama sea administrador (custom claim admin:true en su token de…, requiere_admin(), auditoria_listar(), banner_guardar(), _invalidar_cache_admin_usuarios(), promocion_guardar(), ranking_demo_borrar(), ranking_demo_estado() (+25 more)
...
Cohesion: 0.09
Nodes (11): ba, canRenderSurveyAsync(), getEarlyAccessFeatures(), getProductTours(), getRemoteConfigPayload(), getSurveys(), ma, overrideLinkedFlag() (+3 more)
...
### Community 74 - "startIfEnabledOrStop"
Cohesion: 0.10
Nodes (12): aa(), Bt(), gs(), ht, isEnabled(), la(), na, previewTour() (+4 more)
...
Cohesion: 0.05
Nodes (64): _bajas_agregadas(), bajas_listar(), banner_obtener(), banner_publico(), _bloque_de_tema(), bootstrap_admin(), _celda_csv_segura(), _contar_coleccion() (+56 more)
...
Cohesion: 0.11
Nodes (32): getLegacyLiveConfigPath(), getLiveConfigPath(), resolveLiveConfigPath(), describeInjectArtifacts(), frameworkIgnorePatterns(), PATCH_UNDOERS, resolveFramework(), clearInjectJournal() (+24 more)
...
Cohesion: 0.18
Nodes (19): resolveProjectRoot(), CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveServerPath() (+11 more)
...
Cohesion: 0.07
Nodes (59): acknowledgePendingEvent(), activeSessionSummaries(), agentPollingConnected(), annotRoot, args, broadcast(), broadcastAgentPollingIfChanged(), cancelQueuedAnonymousExitEvents() (+51 more)
...
### Community 102 - "Dn"
Cohesion: 0.08
Nodes (8): Dn, ei, ensureFlagsLoaded(), ii, ke(), Lo, nt(), ti()
...
### Community 132 - "temario.py"
Cohesion: 0.20
Nodes (14): activar_oposicion(), avisos_oficiales(), obtener_oposiciones_disponibles(), obtener_temas_disponibles(), _oposiciones_visibles_para_la_peticion(), progreso_usuario(), route, Rutas de consulta del catálogo de oposiciones y su temario. (+6 more)
...
Cohesion: 0.22
Nodes (9): limites_guardar(), Guarda los límites editados. Solo un admin total puede tocarlos, porque afectan…, _estructura_defecto(), _fusionar_overrides(), guardar_limites_config(), invalidar_cache_limites(), Fuerza recargar los límites de Firestore en la próxima consulta (se llama tras…, Parte de los defaults y superpone SOLO valores válidos y conocidos del… (+1 more)
...
### Community 253 - "_parece_documento_generado_valido"
Cohesion: 0.32
...
### Community 263 - "desactivar_psicotecnicas_incompletas_auxiliar.py"
Cohesion: 0.43
...
### Community 268 - "browser-script-parts.mjs"
Cohesion: 0.33
...
### Community 291 - "info"
Cohesion: 0.18
Nodes (8): al, Bo(), captureException(), Ho(), info(), No(), sendExceptionEvent(), Uo()
...
### Community 319 - "isScreenReaderOnlyTextStyle"
Cohesion: 0.47
...
### Community 335 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
Nodes (4): checkElementRadialSpotlight(), checkElementRadialSpotlightDOM(), elementGradientValue(), spotlightLabel()

### Community 338 - "g"
Cohesion: 0.10
Nodes (21): b(), g(), getAllFeatureFlags(), getFeatureFlag(), getFeatureFlagDetails(), getFeatureFlagPayload(), getFeatureFlagResult(), getFlagPayloads() (+13 more)
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `info`, `constructor`, `concept-seed.mjs`, `.register`, `startIfEnabledOrStop`, `N`, `.push`, `ka`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `usuario_autenticado()` connect `usuario_autenticado` to `test_generar_test_oficial.py`, `test_repaso_espaciado.py`, `test_carpetas_documentos.py`, `sembrar_usuario_activo`, `test_push_notificaciones.py`, `test_generador_preguntas_verificado.py`, `test_verificacion_respuestas_oficiales.py`, `test_resultado_test_oficial.py`, `test_tu_tutor.py`, `test_error_handler.py`, `test_temario.py`, `test_prueba_gratuita.py`, `conftest.py`, `_eventos_sse`, `test_gestion_cuenta.py`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `sembrar_usuario_activo()` connect `sembrar_usuario_activo` to `test_admin.py`, `test_repaso_espaciado.py`, `test_verificacion_respuestas_oficiales.py`, `TestCupoMensualDeSubidas`, `conftest.py`, `test_generar_test_oficial.py`, `_eventos_sse`, `usuario_autenticado`, `TestChatPdfMensaje`, `TestDocumentoEstado`, `test_pdf_ia.py`, `_con_sesion`, `TestCosteIaEnHerramientasPdf`, `TestGenerarEsquemaDesdePdf`, `test_resultado_test_oficial.py`, `test_temario.py`, `TestSubirDocumento`, `test_carpetas_documentos.py`, `_sembrar_tema`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
