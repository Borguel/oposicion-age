...
## Corpus Check
- 439 files · ~1,538,839 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7901 nodes · 17984 edges · 340 communities (304 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 437 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `69037a2b`
...
## Communities (340 total, 36 thin omitted)
...
Cohesion: 0.04
Nodes (126): analitica_contenido(), auditoria_listar(), avisos_oficiales_actualizar(), avisos_oficiales_crear(), avisos_oficiales_editar(), avisos_oficiales_listar(), bajas_listar(), banco_preguntas_resumen() (+118 more)
...
Cohesion: 0.07
Nodes (48): generar_test_avanzado_route(), generar_test_oficial(), generar_test_psicotecnico(), limit, Reparte la selección entre categorías (sinónimos, antónimos, contar cubos,…, Prueba psicotécnica (razonamiento verbal/espacial) de una oposición -- hoy solo…, _seleccionar_preguntas_psicotecnico_equilibradas(), limit (+40 more)
...
Cohesion: 0.10
Nodes (36): _actualizar_memoria_cruzada(), _actualizar_resumen_si_hace_falta(), agregar_mensaje_a_conversacion(), _bloque_explicar_fallo(), _bloque_respuesta_verificada(), crear_conversacion(), _es_modo_examen(), _es_pregunta_de_test() (+28 more)
...
### Community 35 - "documentos_pdf.py"
Cohesion: 0.10
Nodes (25): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, _banco_atascado(), buscar_documento_por_texto(), crear_carpeta(), crear_documento(), eliminar_carpeta(), extraer_titulo() (+17 more)

### Community 36 - "pagos.py"
Cohesion: 0.08
Nodes (46): requiere_login(), promocion_publica(), Lectura pública: el frontend decide si mostrarla según el plan del usuario (o…, cancelar_suscripcion(), contactar_soporte(), crear_sesion_checkout(), crear_sesion_portal(), _current_period_end() (+38 more)

### Community 37 - "getFeatureFlagResult"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (50): coleccion_banco_preguntas(), guardar_pregunta_generada(), Repositorio interno de preguntas de Test Personalizado ya generadas y…, Guarda una pregunta de Test Personalizado ya verificada en el banco de esa…, _bajas_agregadas(), _fallos_agregados(), Todos los usuarios ya decorados (plan efectivo, % de uso, oposiciones…, Una fila por cada oposición que un usuario ha activado alguna vez, con su… (+42 more)
...
Cohesion: 0.10
Nodes (35): Revisa el BOE (leyes vigiladas + sumario diario) y deja en Firestore…, vigilar_boe(), test_verificar_bloque_temas_referenciados_detecta_tema_inexistente(), test_verificar_bloque_temas_referenciados_no_duplica_entre_leyes(), test_verificar_bloque_temas_referenciados_sin_faltantes_si_todo_existe(), _buscar_clave(), _buscar_lista(), _clasificar_aviso() (+27 more)
...
Cohesion: 0.15
Nodes (16): _fake_response(), _metadatos(), Pruebas de vigilancia_boe.py: nunca publica/aplica nada sola -- solo crea…, _respuesta_http_error(), _sumario_con_item(), test_bloque_con_texto_solo_espacios_se_descarta(), test_clasificar_aviso_llamamiento_extraordinario_no_es_fecha_examen(), test_detectar_avisos_oficiales_crea_aviso_pendiente() (+8 more)
...
Cohesion: 0.14
Nodes (22): _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking(), route, Clasificación de racha de estudio: anónima y estrictamente opcional. Solo…, Lista de {uid, alias, racha_actual} de todos los apuntados al ranking, ordenada…, salir_ranking() (+14 more)
...
Cohesion: 0.06
Nodes (45): _preguntas_stats(), Cuenta preguntas oficiales activas / inactivas / sin explicación., main(), Sube a Firestore los datos oficiales de la convocatoria vigente de una…, cargar(), Carga la prueba psicotécnica (aptitudinal) del Metro de Madrid, convocatoria…, aplicar(), doc_ids() (+37 more)
...
Cohesion: 0.07
Nodes (57): verifyAcceptedSource(), applyLegacyDeferredAcceptsOnStartup(), buildPropsScriptV2(), loadSvelteCompiler(), appendCssToSvelteStyle(), appendSanitizedCssRule(), applyDeferredSvelteComponentAccepts(), bakeParamValuesInCss() (+49 more)
...
### Community 131 - "resolveProjectRoot"
Cohesion: 0.28
Nodes (13): resolveProjectRoot(), getLegacyLiveAnnotationsDir(), getLegacyLiveSessionsDir(), getSurfaceBriefDir(), listSurfaceBriefs(), normalizeSurfaceTarget(), parseSurfaceBrief(), resolveSurfaceBrief() (+5 more)
...
Cohesion: 0.10
Nodes (17): client(), flask_app(), _limpiar_fake_db(), fixture, Configuración compartida de pytest: prepara variables de entorno dummy y…, Pruebas del catálogo de carpetas de Mis Documentos (documentos_pdf.py + rutas…, test_listar_carpetas_incluye_las_ya_usadas_por_documentos_antiguos(), test_ruta_crear_carpeta_devuelve_error_si_esta_vacio() (+9 more)
...
Cohesion: 0.10
Nodes (36): applyFixes(), cli(), parseArgs(), rel(), renderText(), SCRIPTS_DIR, SEVERITY_LABEL, usage() (+28 more)
...
### Community 203 - "instructions.mjs"
Cohesion: 0.40
...
### Community 231 - "_recortar_a_bytes_utf8"
Cohesion: 0.27
...
Cohesion: 0.04
Nodes (78): estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz(), Sin autenticación a propósito: la usa el monitor externo (GitHub Actions, o el…, verificar_api_key() (+70 more)
...
### Community 306 - "completar_tema_gace_sector_publico.py"
Cohesion: 0.53
...
### Community 314 - "obtener_tests_en_progreso_por_documento"
Cohesion: 0.39
...
### Community 325 - "eliminar_documento"
Cohesion: 0.43
...
### Community 330 - "tu_tutor_sugerencia_inicial"
Cohesion: 0.33
Nodes (6): eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), route, Recomendación proactiva para el saludo de bienvenida del chat. Es determinista…, tu_tutor_sugerencia_inicial()

### Community 331 - "descargarResultadosPDF"
Cohesion: 0.53
...
- **Why does `error()` connect `error` to `posthog-array.js`, `ya`, `g`, `concept-seed.mjs`, `al`, `Ga`, `N`?**
...
- **Why does `usuario_autenticado()` connect `usuario_autenticado` to `test_generar_test_oficial.py`, `pagos.py`, `conftest.py`, `sembrar_usuario_activo`, `test_generador_preguntas_verificado.py`, `push_utils.py`, `test_resultado_test_oficial.py`, `test_tu_tutor.py`, `_clave_periodo`, `test_verificacion_respuestas_oficiales.py`, `test_temario.py`, `auth_utils.py`, `test_repaso_espaciado.py`?**
