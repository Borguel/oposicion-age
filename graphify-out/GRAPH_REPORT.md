...
## Corpus Check
- 443 files · ~1,553,253 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8092 nodes · 18534 edges · 340 communities (300 shown, 40 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 428 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78144ceb`
...
1. `usuario_autenticado()` - 156 edges
2. `_como()` - 151 edges
3. `sembrar_usuario_activo()` - 110 edges
4. `ya` - 107 edges
5. `_con_sesion()` - 106 edges
6. `call_deepseek_api()` - 70 edges
7. `requiere_plan()` - 63 edges
8. `db()` - 58 edges
...
Cohesion: 0.11
Nodes (37): _clave_cron_valida(), enviar_recordatorios_activacion(), enviar_recordatorios_prueba(), enviar_recordatorios_racha(), route, Tareas activadas por un cron externo (GitHub Actions), no por un usuario --…, Avisa por email del final de la prueba gratuita Premium (planes.py): 2 días…, Avisa a quien se registró pero nunca llegó a activar ninguna oposición… (+29 more)

### Community 5 - "test_publicacion_estatica_boe.py"
Cohesion: 0.06
Nodes (59): actualizar_pagina_estatica_avisos(), _cabeceras(), _consultar_avisos_publicados(), _consultar_avisos_publicados_todos(), _escribir_archivo_github(), etiqueta_tipo_aviso(), etiquetas_oposiciones_aviso(), generar_html_avisos() (+51 more)

### Community 6 - "pdf_ia.py"
Cohesion: 0.07
Nodes (82): Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_plan(), marcar_repasadas(), Actualiza fecha_ultimo_repaso de las preguntas que acaban de salir en un test…, chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion() (+74 more)

### Community 7 - "admin.py"
Cohesion: 0.03
Nodes (160): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que quien llama tenga AL MENOS UNO de los permisos indicados (o sea…, requiere_admin(), requiere_permiso(), analitica_contenido(), auditoria_listar(), avisos_oficiales_actualizar(), avisos_oficiales_crear() (+152 more)

### Community 8 - "test_utils.py"
Cohesion: 0.13
Nodes (24): _normalizar_pregunta_pdf(), Deja una pregunta cruda de generar_preguntas_ia_en_lotes/…, _pregunta_base(), Pruebas de utils.barajar_opciones_pregunta: los LLM tienden a poner la…, test_conserva_las_4_opciones_sin_perder_ni_duplicar_contenido(), test_explicacion_remapeada_a_la_nueva_letra_correcta(), test_no_siempre_deja_la_correcta_en_a(), test_no_toca_explicacion_que_no_sigue_el_formato_por_letra() (+16 more)
...
Cohesion: 0.11
Nodes (35): _elegir_ancla_legal(), _elegir_tipo_pregunta(), _extraer_articulos(), _generar_pregunta_verificada(), generar_test_verificado(), Trocea el texto verbatim de un subbloque en fragmentos por artículo real. Si no…, Elige 1 (o 2, para 'distincion_articulos') fragmento(s) de artículo real sobre…, Genera hasta num_preguntas preguntas verificadas, repartidas entre 'temas'… (+27 more)

### Community 13 - "live-browser.js"
Cohesion: 0.03
Nodes (144): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels(), buildInsertPlaceholderSnapshotFromDom() (+136 more)
...
Cohesion: 0.05
Nodes (67): Todos los usuarios ya decorados (plan efectivo, % de uso, oposiciones…, % de uso MÁS ALTO entre todas las herramientas del usuario en su periodo…, _todos_usuarios_decorados(), _uso_pico(), eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), limit (+59 more)

### Community 18 - "admin/script.js"
Cohesion: 0.06
Nodes (37): activarPestana(), alternarSubmenuSidebar(), atraparTabEnModal(), _avisoTemasFaltantesHtml(), bloquesAbiertos, bloquesAbiertosPreguntas, _cargarSaludVigilancia(), cerrarSidebar() (+29 more)
...
Cohesion: 0.09
Nodes (43): _actualizar_memoria_cruzada(), _actualizar_resumen_si_hace_falta(), agregar_mensaje_a_conversacion(), _bloque_explicar_fallo(), _bloque_respuesta_verificada(), crear_conversacion(), _es_modo_examen(), _es_pregunta_de_test() (+35 more)

### Community 23 - "registro_progreso_usuario.py"
Cohesion: 0.05
Nodes (76): _decodificar_token_admin(), _decodificar_token_peticion(), _permisos_de(), Verifica el token Bearer y devuelve (decoded, None) o (None, respuesta de…, Conjunto de permisos efectivos del token. El super-admin los tiene todos., verify_id_token() con un reintento ante fallos de red al obtener los…, Header Authorization: Bearer <token> ya verificado -- el dict crudo que…, _verificar_id_token() (+68 more)

### Community 24 - "test_documentos_pdf.py"
Cohesion: 0.03
Nodes (76): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), anadir_al_banco(), _banco_atascado(), _banco_ref() (+68 more)
...
Cohesion: 0.04
Nodes (85): obtener_oposicion_solicitada(), Lee sobre qué oposición pide contenido la petición actual (query string…, actualizar_banco_fallos(), listar_fallos(), ordenar_por_prioridad_repaso(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, desmarcar_favorita() (+77 more)
...
Cohesion: 0.08
Nodes (43): Mockea auth_utils.firebase_auth.verify_id_token para simular una sesión…, usuario_autenticado(), _mock_precio(), Pruebas de las rutas que crean sesiones de pago en Stripe (/crear-sesion-…, test_cancelar_suscripcion_con_subscription_id_huerfano_se_marca_gratis_localmente(), test_cancelar_suscripcion_error_de_stripe_da_500_sin_filtrar_el_mensaje_crudo(), test_cancelar_suscripcion_no_marca_gratis_si_el_error_no_es_resource_missing(), test_cancelar_suscripcion_programa_la_baja_y_guarda_el_motivo() (+35 more)
...
Cohesion: 0.13
Nodes (33): call_deepseek_api(), generar_contenido_desde_texto(), _leer_respuesta_completa(), _leer_respuesta_en_streaming(), Llamada clásica (stream=false): se espera a la respuesta entera y se devuelve…, Misma llamada pero con stream=true, consumiendo el SSE entero aquí dentro y…, Función genérica para generar diferentes tipos de contenido desde texto, Función mejorada para llamar a la API de DeepSeek con mejor manejo de errores.… (+25 more)
...
### Community 55 - "deepseek_utils.py"
Cohesion: 0.05
Nodes (48): main(), Sube a Firestore los datos oficiales de la convocatoria vigente de una…, cargar_examen(), generar_explicacion(), Carga el Ejercicio Único de una convocatoria AGE (Cuerpo General Administrativo…, cargar_examen(), generar_explicacion(), Carga el Ejercicio Único de una convocatoria del Cuerpo General Auxiliar de la… (+40 more)
...
Cohesion: 0.14
Nodes (21): /assets/favoritas.js, activarBotonFavorita(), actualizarNavegadorPreguntas(), botonFavoritaHTML(), cargarListaTemas(), confirmarFinalizar(), formatearMinSeg(), generarComparacionIntentosHTML() (+13 more)

### Community 59 - "test_email_utils.py"
Cohesion: 0.14
Nodes (26): enviar_email_activar_oposicion(), enviar_email_aviso_oficial(), enviar_email_bienvenida(), enviar_email_cancelacion_suscripcion(), Correo único al crear la cuenta (ver inicializar_estadisticas_usuario en…, Confirmación de que la baja se ha registrado -- se manda al aceptar /cancelar-…, Aviso para quien se registró pero nunca llegó a activar ninguna oposición: sin…, Aviso de que se ha publicado algo oficial relevante (convocatoria, lista de… (+18 more)
...
Cohesion: 0.26
Nodes (11): crear_carpeta(), listar_carpetas(), Catálogo de carpetas del usuario: las creadas explícitamente con…, Pruebas del catálogo de carpetas de Mis Documentos (documentos_pdf.py + rutas…, test_carpeta_recien_creada_aparece_vacia(), test_crear_carpeta_con_nombre_vacio_no_hace_nada(), test_eliminar_carpeta_deja_sin_carpeta_los_documentos_dentro(), test_listar_carpetas_incluye_las_ya_usadas_por_documentos_antiguos() (+3 more)
...
### Community 73 - "test_guardar_test_con_numeros_del_bug_guarda_suspendido"
Cohesion: 0.67
...
### Community 76 - "syncPageChatFocus"
Cohesion: 0.21
...
### Community 77 - "auth_publico.py"
Cohesion: 0.17
Nodes (14): enviar_verificacion_email(), route, Rutas de autenticación relacionadas con correos que Firebase mandaría por su…, Genera el enlace de restablecimiento de contraseña con Firebase Admin y lo…, Genera el enlace de verificación de correo con Firebase Admin y lo envía por…, recuperar_contrasena(), _aviso(), enviar_email_recuperar_contrasena() (+6 more)

### Community 78 - "tarjetas_generator.py"
Cohesion: 0.23
Nodes (10): _asegurar_tarjeta_valida(), _generar_candidatas_fragmento(), _prompt_con_exclusion(), _prompt_generacion(), _prompt_verificacion(), Generador de tarjetas de memoria (flashcards) a partir de un PDF subido por el…, Añade al prompt de generación la lista de tarjetas que NO debe repetir -- ya…, tarjetas_aceptadas: lista compartida (protegida por dedup_lock) de las tarjetas… (+2 more)

### Community 79 - "estadisticas/script.js"
Cohesion: 0.13
Nodes (23): /assets/dom.js, renderizarSelectorTemas(), actualizarAnillo(), animarLineaTiempo(), reproducir(), easeInOutCubic(), paso(), cargarDatos() (+15 more)
...
Cohesion: 0.20
Nodes (30): abrirModal(), abrirUsuario(), api(), apiGet(), buscarYEditarPregunta(), cargarChunks(), cargarPreguntas(), cargarUsuarios() (+22 more)
...
### Community 93 - "cargarAvisosOficiales"
Cohesion: 0.21
Nodes (14): actualizarBadgeBoe(), _actualizarStatBoe(), _avisoTokenGithubHtml(), cambiarEstadoAvisoOficial(), cambiarEstadoCambioTemario(), cargarAvisosOficiales(), cargarCambiosTemario(), _crearAvisoManual() (+6 more)
...
### Community 100 - "cargarIngresos"
Cohesion: 0.23
Nodes (12): cargarAuditoria(), cargarErroresIA(), cargarIngresos(), descargarCSV(), marcarErrorIA(), paginacionHtml(), _paramsIngresos(), renderAuditoria() (+4 more)

### Community 101 - "zo"
Cohesion: 0.12
Nodes (5): di(), hi, onConfigChange(), ui(), zo

### Community 102 - "reasignar_temas_examenes.py"
Cohesion: 0.27
...
Cohesion: 0.08
Nodes (37): Siembra usuarios/{uid} con una suscripción de pago ya activa (evita tener que…, sembrar_usuario_activo(), Borrado de tests propios (finalizados y en progreso) desde Mis Tests., test_borrar_test_de_otro_usuario_no_lo_afecta(), test_borrar_test_en_progreso(), test_borrar_test_en_progreso_no_toca_las_estadisticas(), test_borrar_test_finalizado(), test_borrar_test_finalizado_revierte_las_estadisticas_agregadas() (+29 more)
...
Cohesion: 0.13
Nodes (51): applyEditing(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), captureAndEmit(), cleanup(), cleanupAcceptedSession(), clearAnnotations() (+43 more)

### Community 110 - "test_tarjetas_generator.py"
Cohesion: 0.25
Nodes (4): _contiene_frase_prohibida(), Filtro determinista (no depende de que la IA de verificación lo detecte): igual…, Pruebas de tarjetas_generator.py: reparto de cupos entre fragmentos, parseo de…, TestContieneFrasesProhibidas
...
Cohesion: 0.06
Nodes (79): abortSvelteComponentInjection(), applyParamDefaults(), applyParamValue(), applyPlaceholderDimensions(), applySavedSessionMeta(), buildParamsPanel(), checkpointPayload(), clampVariantIndex() (+71 more)
...
### Community 115 - "test_autosave_resume.py"
Cohesion: 0.22
...
Cohesion: 0.16
Nodes (12): /assets/auth.js, /assets/firebase-config.js, MAX_PAGINAS_POR_PLAN, NOMBRE_PLAN, atributosEnlace(), cargarAvisos(), elCargando, elLista (+4 more)
...
### Community 127 - "checkElementGptBorderShadow"
Cohesion: 0.38
...
### Community 153 - "showToast"
Cohesion: 0.08
Nodes (46): abandonForeignSession(), armPageChatForTyping(), buildSteerProcessingDots(), buildSteerQueueHint(), clearSteerAwaitTimer(), collapsePageChat(), discardOrphanedSession(), dismissToast() (+38 more)
...
Cohesion: 0.09
Nodes (39): agentHasWorkInFlight(), agentStatusText(), barPaletteForTheme(), brandMarkSvg(), buildDesignHeader(), buildSavingRow(), designPanelCss(), detectPageTheme() (+31 more)
...
### Community 213 - "_parsear_tarjetas"
Cohesion: 0.43
...
### Community 217 - "utils.py"
Cohesion: 0.05
Nodes (65): coleccion_banco_preguntas(), guardar_pregunta_generada(), Repositorio interno de preguntas de Test Personalizado ya generadas y…, Guarda una pregunta de Test Personalizado ya verificada en el banco de esa…, _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking() (+57 more)
...
Cohesion: 0.20
Nodes (14): parseCliOptions(), parseTargetOptions(), parseTargetPath(), TargetArgError, __dirname, ensureServerRunning(), globToRegex(), liveCli() (+6 more)
...
### Community 232 - "test_contadores_preguntas.py"
Cohesion: 0.29
Nodes (6): Fase 1 del loop de dificultad calibrada: contadores atómicos por pregunta…, test_fallo_en_el_batch_no_rompe_la_correccion_del_test(), test_guardar_test_acumula_entre_tests_sucesivos_de_distintos_usuarios(), test_guardar_test_incrementa_contadores_de_cada_pregunta(), test_pregunta_marcada_duda_no_alimenta_los_contadores(), test_total_aciertos_nunca_supera_total_respuestas()
...
Cohesion: 0.18
Nodes (19): actualizarBadgeReportes(), _actualizarBadgesReportesDesglose(), cambiarEstadoReporte(), cambiarEstadoSoporte(), cargarReportes(), cargarSoporte(), escapeHtml(), fechaCorta() (+11 more)
...
### Community 250 - "completar_tema_gace_sector_publico.py"
Cohesion: 0.53
...
Cohesion: 0.22
Nodes (8): createLiveBrowserDomHelpers(), cssId(), liveUiRoot(), makeFrozenAnchor(), rectIsUsableAnchor(), uiAppend(), uiAppendStyle(), uiGetById()

### Community 253 - "_repartir_cupos"
Cohesion: 0.47
...
### Community 263 - "obtener_contexto_por_temas_exactos"
Cohesion: 0.47
...
Cohesion: 0.09
Nodes (42): requiere_login(), promocion_publica(), Lectura pública: el frontend decide si mostrarla según el plan del usuario (o…, cancelar_suscripcion(), contactar_soporte(), crear_sesion_checkout(), crear_sesion_portal(), _current_period_end() (+34 more)
...
### Community 268 - "app.py"
Cohesion: 0.07
Nodes (34): demasiadas_peticiones(), estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz(), Sin autenticación a propósito: la usa el monitor externo (GitHub Actions, o el… (+26 more)
...
### Community 306 - "buscar_pregunta_banco_ia"
Cohesion: 0.20
...
Cohesion: 0.23
Nodes (6): Trocea el texto en fragmentos de como mucho 'tamano' caracteres, cortando…, _trocear_en_parrafos(), _trocear_recursivo(), generar_banco_tarjetas_adaptativo(), Genera el máximo de tarjetas distintas que el documento realmente dé de sí, en…, TestGenerarBancoTarjetasAdaptativo
...
### Community 356 - "hook.mjs"
Cohesion: 0.39
Nodes (7): allow(), deny(), done(), isStopEvent(), writeAuditLog(), main(), readStdin()

## Knowledge Gaps
- **945 isolated node(s):** `PERMISO_POR_PESTANA`, `_permisos`, `modal`, `modalContenido`, `GRUPOS` (+940 more)
...
- **Why does `error()` connect `error` to `warn`, `posthog-array.js`, `ya`, `.Dr`, `concept-seed.mjs`, `po`, `al`, `N`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `registrar_error_generacion`, `pdf_ia.py`, `test_generador_preguntas_verificado.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `generador_preguntas_verificado.py`, `deepseek_utils.py`, `_fragmentos_por_lote`, `cargar_temario_boe.py`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `tarjetas_generator.py`, `generar_propuesta_cambio`, `TestGeneracionEnLote`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `verificar_limite_uso()` connect `pdf_ia.py` to `test_limites_uso.py`, `test_admin.py`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Are the 61 inferred relationships involving `usuario_autenticado()` (e.g. with `test_ruta_generar_test_avanzado_429_si_supera_el_limite()` and `test_ruta_generar_test_avanzado_429_si_supera_el_tope_mensual_aunque_el_diario_este_libre()`) actually correct?**
  _`usuario_autenticado()` has 61 INFERRED edges - model-reasoned connections that need verification._
