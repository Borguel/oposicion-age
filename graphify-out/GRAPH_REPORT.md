# Graph Report - oposicion-age  (2026-08-26)
...
## Summary
- 8149 nodes · 18665 edges · 344 communities (308 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 432 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f97e241d`
...
## Communities (344 total, 36 thin omitted)
...
Cohesion: 0.03
Nodes (77): aa(), addExceptionStep(), addFeatureFlagsHandler(), Bo(), Br, Bs(), captureException(), captureLog() (+69 more)
...
Cohesion: 0.03
Nodes (138): applyGlobalBarLabelState(), applyParamValue(), applyPlaceholderSizingStyles(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels() (+130 more)
...
### Community 24 - "_o"
Cohesion: 0.15
Nodes (9): bn(), cn(), d(), _e(), fn(), mn(), _o(), vn() (+1 more)
...
### Community 30 - "g"
Cohesion: 0.07
Nodes (40): as(), b(), Ca(), cs(), ds(), Ea(), fs(), g() (+32 more)
...
### Community 60 - "po"
Cohesion: 0.08
Nodes (12): Ao, ba, do(), fe(), gs(), isEnabled(), ja(), ma (+4 more)
...
Cohesion: 0.06
Nodes (39): actualizar_progreso_generacion(), actualizar_titulo(), eliminar_documento(), limite_regeneraciones_alcanzado(), limpiar_progreso_generacion(), listar_documentos(), marcar_generado(), obtener_o_crear_documento() (+31 more)
...
### Community 103 - "filterFindings"
Cohesion: 0.16
Nodes (18): clampToBudget(), cleanIgnoreValueDisplay(), directiveFooter(), extractFindingIgnoreValue(), extractFindingIgnoreValueRaw(), extractMotionIgnoreValue(), filterFindings(), findingMatchesScopedIgnoreFile() (+10 more)
...
Cohesion: 0.07
Nodes (81): abortSvelteComponentInjection(), applyParamDefaults(), applySavedSessionMeta(), buildInsertPlaceholderSnapshotFromDom(), buildPickedAnchorSnapshot(), captureAndEmit(), checkpointPayload(), cleanup() (+73 more)
...
Cohesion: 0.06
Nodes (57): ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), clampByte(), clampGroupedToBudget() (+49 more)
...
Cohesion: 0.08
Nodes (52): abandonForeignSession(), armPageChatForTyping(), attachSteerFocusDebug(), attachSteerFocusGuard(), clearSteerAwaitTimer(), clearSteerFocusRecoverTimer(), collapsePageChat(), discardOrphanedSession() (+44 more)
...
Cohesion: 0.08
Nodes (46): agentHasWorkInFlight(), agentStatusText(), barPaletteForTheme(), brandMarkSvg(), buildDesignHeader(), buildParamsPanel(), buildSteerQueueHint(), designPanelCss() (+38 more)
...
### Community 211 - "surface-briefs.mjs"
Cohesion: 0.38
...
### Community 218 - "_recortar_a_bytes_utf8"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (24): acceptedDomAlreadyClean(), applyOriginalAttrsToSvelteAnchor(), commitAcceptedSvelteComponentToDom(), componentModuleCandidates(), describeMountFailure(), detectDevServerBase(), ensureAcceptedDomClean(), findAcceptedRuntimeWrappers() (+16 more)
...
### Community 229 - "documentos_pdf.py"
Cohesion: 0.07
Nodes (35): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_tipo_contenido(), _banco_atascado(), buscar_documento_por_texto(), crear_carpeta(), crear_documento(), eliminar_carpeta() (+27 more)
...
### Community 236 - "live-complete.mjs"
Cohesion: 0.39
...
### Community 240 - "_parece_documento_generado_valido"
Cohesion: 0.32
...
### Community 248 - "obtener_tests_en_progreso_por_documento"
Cohesion: 0.39
...
### Community 253 - "test_mi_perfil.py"
Cohesion: 0.25
...
### Community 330 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `.push`, `concept-seed.mjs`, `ke`, `N`, `al`, `De`, `_o`, `po`, `g`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `registrar_error_generacion`, `pdf_ia.py`, `_guardar_turno`, `tarjetas_generator.py`, `test_generador_preguntas_verificado.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `deepseek_utils.py`, `cargar_temario_gace_bloque2_ue.py`, `generador_preguntas_verificado.py`, `_fragmentos_por_lote`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_boe.py`, `cargar_temario_metro.py`, `generar_propuesta_cambio`, `test_ia.py`, `TestGeneracionEnLote`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `sembrar_usuario_activo()` connect `sembrar_usuario_activo` to `test_admin.py`, `test_repaso_espaciado.py`, `test_verificacion_respuestas_oficiales.py`, `TestCupoMensualDeSubidas`, `test_reconciliar_stripe.py`, `test_generar_test_oficial.py`, `_eventos_sse`, `registro_progreso_usuario.py`, `TestChatPdfMensaje`, `TestDocumentoEstado`, `test_pdf_ia.py`, `_con_sesion`, `TestCosteIaEnHerramientasPdf`, `TestGenerarEsquemaDesdePdf`, `test_temario.py`, `TestSubirDocumento`, `conftest.py`, `documentos_pdf.py`, `_sembrar_tema`, `test_mi_perfil.py`?**
...
- **Should `posthog-array.js` be split into smaller, more focused modules?**
  _Cohesion score 0.030337558752314486 - nodes in this community are weakly interconnected._