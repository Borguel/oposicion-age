...
## Corpus Check
- 444 files · ~1,561,083 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8148 nodes · 18635 edges · 341 communities (304 shown, 37 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 442 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0184140b`
...
## Communities (341 total, 37 thin omitted)
...
Cohesion: 0.10
Nodes (57): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_admin(), requiere_plan(), chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion() (+49 more)

### Community 7 - "admin.py"
Cohesion: 0.04
Nodes (78): auditoria_listar(), banner_guardar(), banner_obtener(), banner_publico(), bootstrap_admin(), cambios_temario_listar(), _celda_csv_segura(), _contar_coleccion() (+70 more)

### Community 8 - "utils.py"
Cohesion: 0.08
Nodes (41): _normalizar_pregunta_pdf(), Deja una pregunta cruda de generar_preguntas_ia_en_lotes/…, _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking(), route, Clasificación de racha de estudio: anónima y estrictamente opcional. Solo… (+33 more)
...
Cohesion: 0.05
Nodes (73): coleccion_banco_preguntas(), guardar_pregunta_generada(), Repositorio interno de preguntas de Test Personalizado ya generadas y…, Guarda una pregunta de Test Personalizado ya verificada en el banco de esa…, _bloques_contenido(), _bloques_texto_legal(), _elegir_ancla_legal(), _elegir_tipo_pregunta() (+65 more)
...
Cohesion: 0.09
Nodes (46): responder_tutor(), Pruebas de Tu Tutor (chat_controller.responder_tutor + blueprints/tu_tutor.py):…, El modelo de DeepSeek que usa Tu Tutor es configurable sin redeploy vía…, _sembrar_tema(), test_contexto_de_pagina_pasa_la_pregunta_en_pantalla(), test_contexto_personal_del_usuario_se_incluye_en_el_prompt(), test_contexto_personal_incluye_la_nota_del_ultimo_test(), test_conversacion_normal_si_conserva_el_historial() (+38 more)
...
Cohesion: 0.06
Nodes (67): eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), limit, route, Tu Tutor: chat conversacional unificado (antes eran dos herramientas separadas…, Recomendación proactiva para el saludo de bienvenida del chat. Es determinista…, tu_tutor_route() (+59 more)
...
Cohesion: 0.03
Nodes (152): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), buildHtmlPatternCorpora(), checkBorders(), checkClippedOverflow(), checkColors(), checkCreamPalette() (+144 more)

### Community 22 - "chat_controller.py"
Cohesion: 0.11
Nodes (33): _actualizar_memoria_cruzada(), _actualizar_resumen_si_hace_falta(), agregar_mensaje_a_conversacion(), _bloque_explicar_fallo(), _bloque_respuesta_verificada(), crear_conversacion(), _es_modo_examen(), _es_pregunta_de_test() (+25 more)

### Community 23 - "test_prueba_gratuita.py"
Cohesion: 0.07
Nodes (55): es_dominio_email_desechable(), Dominios de correo desechable/temporal conocidos: una cuenta creada con uno de…, True si el dominio del email está en la lista conocida de correo…, conectar_firestore(), main(), migrar(), Migración única: antes de este cambio existía un plan "gratis" permanente;…, prueba_activa() (+47 more)

### Community 24 - "requiere_permiso"
Cohesion: 0.09
Nodes (50): analitica_contenido(), avisos_oficiales_crear(), banco_preguntas_resumen(), cambios_temario_actualizar(), errores_ia_actualizar(), _id_valido(), preguntas_crear(), preguntas_desactivar() (+42 more)
...
### Community 30 - "resolveLengthPx"
Cohesion: 0.10
Nodes (28): checkElementOversizedH1(), checkElementOversizedH1DOM(), checkElementQuality(), checkElementQualityDOM(), checkKickerAboveHeading(), checkKickerAboveHeadingDOM(), checkKickerAboveHeadingFromDoc(), checkNumberedSectionLabels() (+20 more)

### Community 31 - "deepseek_utils.py"
Cohesion: 0.05
Nodes (42): _volcar_coste_ia(), _generar_documento_validado(), Envoltorio de generar_documento_largo_por_partes que, si el resultado no supera…, acumular_usage(), coste_estimado(), flush_coste(), guardar_coste_directo(), _incrementar_mes() (+34 more)
...
Cohesion: 0.07
Nodes (29): AGENT_PHASE_SET, FORBIDDEN_MANUAL_EDIT_TEXT_CHARS, INSERT_POSITIONS, isValidId(), isValidMountVariant(), isValidVariantId(), MOUNT_ERROR_MAX_LENGTH, MOUNT_URL_MAX_LENGTH (+21 more)

### Community 34 - "test_ia.py"
Cohesion: 0.06
Nodes (50): analisis_rendimiento(), demo_test_oficial(), generar_test_avanzado_route(), generar_test_fallos(), generar_test_favoritas(), generar_test_oficial(), generar_test_psicotecnico(), guardar_test_oficial() (+42 more)
...
Cohesion: 0.06
Nodes (51): actualizar_banco_fallos(), listar_fallos(), ordenar_por_prioridad_repaso(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, desmarcar_favorita(), listar_favoritas(), marcar_favorita() (+43 more)
...
### Community 59 - "captureElementToBlob"
Cohesion: 0.12
...
Cohesion: 0.04
Nodes (64): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), _banco_atascado(), buscar_documento_por_texto(), eliminar_documento() (+56 more)
...
Cohesion: 0.20
Nodes (15): promocion_publica(), Lectura pública: el frontend decide si mostrarla según el plan del usuario (o…, leer_promocion(), promocion_vigente(), Lectura de la promoción/descuento activo -- compartido entre…, Activa Y, si tiene fecha de fin, que todavía no haya pasado. Falla CERRADO ante…, Pruebas de promociones.py: decide si el descuento activo se aplica de verdad en…, test_leer_promocion_lee_lo_guardado() (+7 more)
...
Cohesion: 0.20
Nodes (9): _modelo_tutor(), Si chat_id ya existe, usa la oposición con la que se creó ESA conversación (ver…, _resolver_oposicion_conversacion(), responder_tutor_stream(), test_responder_tutor_stream_emite_deltas_y_guarda_al_final(), test_responder_tutor_stream_emite_error_si_deepseek_no_devuelve_nada(), test_responder_tutor_stream_emite_error_si_falla_preparar_contexto(), test_stream_incluye_temas_relacionados_para_generar_test() (+1 more)
...
Cohesion: 0.06
Nodes (62): _clave(), desregistrar(), Control de parada para generaciones en segundo plano (resumen, esquema, test,…, Crea (o reinicia, si por lo que sea quedó uno viejo sin desregistrar) el evento…, Se llama SIEMPRE al terminar (con éxito, con error, o porque se pidió parar) --…, Marca el evento de parada de esta generación, si sigue en curso. Devuelve True…, Marca la parada de TODAS las generaciones en curso de un usuario, sin necesitar…, registrar() (+54 more)
...
Cohesion: 0.10
Nodes (33): resolveProjectRoot(), resolveTargetSelection(), CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir() (+25 more)

### Community 93 - "syncPageChatFocus"
Cohesion: 0.21
...
### Community 99 - "obtener_contexto_por_temas_exactos"
Cohesion: 0.47
...
Cohesion: 0.33
Nodes (8): atributosEnlace(), cargarAvisos(), elCargando, elLista, elVacio, importAuth(), renderizarItem(), renderizarSeccion()
...
Cohesion: 0.07
Nodes (48): getLegacyLiveSessionsDir(), getLiveSessionsDir(), FORBIDDEN, verifyAcceptedFile(), completeCli(), completeThroughServer(), parseArgs(), readServerInfo() (+40 more)
...
Cohesion: 0.06
Nodes (59): ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), clampByte(), cloneDefaultConfig() (+51 more)
...
Cohesion: 0.12
Nodes (32): confirm(), detectCli(), dim(), fileUrlToLocalPath(), formatAdvisorySection(), formatFindings(), formatFindingsBody(), formatFindingSummary() (+24 more)
...
### Community 176 - "buscar_pregunta_banco_ia"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (40): safeSessionId(), acceptCli(), acceptReceiptPath(), argVal(), buildAcceptedWrappedSource(), buildCarbonizeReplacement(), decodeHtmlAttr(), deindentContent() (+32 more)
...
Cohesion: 0.06
Nodes (56): handleStdin(), blankCssComments(), CSS_IN_JS_EXTENSIONS, detectText(), extFromFilePath(), extractCSSinJS(), extractStyleBlocks(), firstOverusedGoogleFont() (+48 more)

### Community 192 - "_desde_cache_o_calcular"
Cohesion: 0.13
Nodes (15): _bajas_agregadas(), bajas_listar(), _bloque_de_tema(), _fallos_agregados(), preguntas_listar(), bloque_06-tema_01' -> 'bloque_06'. Vacío si no tiene ese formato., Agrega el banco de falladas de TODOS los usuarios (collection_group) -- solo…, Agrega los motivos de baja de TODOS los usuarios (collection_group) -- por… (+7 more)
...
### Community 218 - "test_guardar_resultado_test_no_duplica.py"
Cohesion: 0.43
...
Cohesion: 0.05
Nodes (67): cuerpo_json_invalido(), demasiadas_peticiones(), estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz() (+59 more)
...
### Community 333 - "test_resultado_test_oficial.py"
Cohesion: 0.12
Nodes (31): actualizar_estadisticas_esquema(), actualizar_estadisticas_test(), Deshace en estadisticas.{oposicion} la contribución de UN test ya guardado (ver…, revertir_estadisticas_test(), conectar_firestore(), corregir(), main(), Corrección única: el campo "resultado" (aprobado/suspendido) de un test se… (+23 more)
...
- **Why does `error()` connect `error` to `posthog-array.js`, `ya`, `constructor`, `concept-seed.mjs`, `ka`, `De`, `N`, `g`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `pdf_ia.py`, `tarjetas_generator.py`, `test_generador_preguntas_verificado.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `deepseek_utils.py`, `test_ia.py`, `cargar_examen_oficial_gace.py`, `_fragmentos_por_lote`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `cargar_temario_boe.py`, `generar_propuesta_cambio`, `cargar_examen_oficial_age.py`, `cargar_examen_oficial_auxiliar.py`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `_fragmentos_por_lote()` connect `_fragmentos_por_lote` to `_bloques_estructurales`, `_repartir_bloques_en_lotes`, `TestGenerarPreguntasIaEnLotes`, `generar_banco_preguntas_adaptativo`, `test_generator.py`?**
