...
## Corpus Check
- 443 files · ~1,557,049 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8128 nodes · 18529 edges · 356 communities (313 shown, 43 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 439 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b5aab79`
...
2. `_como()` - 151 edges
3. `sembrar_usuario_activo()` - 111 edges
4. `ya` - 107 edges
5. `_con_sesion()` - 106 edges
6. `call_deepseek_api()` - 69 edges
7. `db()` - 57 edges
8. `requiere_plan()` - 55 edges
...
## Communities (356 total, 43 thin omitted)
...
Cohesion: 0.03
Nodes (86): aa(), addFeatureFlagsHandler(), Bo(), Br, Ca(), captureException(), captureLog(), Ce() (+78 more)

### Community 3 - "ya"
Cohesion: 0.04
Nodes (21): canRenderSurvey(), clearCache(), critical(), destroy(), displaySurvey(), error(), flushLogs(), getEarlyAccessFeatures() (+13 more)
...
Cohesion: 0.11
Nodes (53): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_admin(), requiere_plan(), chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion() (+45 more)

### Community 7 - "admin.py"
Cohesion: 0.05
Nodes (117): analitica_contenido(), auditoria_listar(), avisos_oficiales_crear(), avisos_oficiales_editar(), avisos_oficiales_listar(), bajas_listar(), banco_preguntas_resumen(), banner_guardar() (+109 more)
...
Cohesion: 0.11
Nodes (44): responder_tutor(), Pruebas de Tu Tutor (chat_controller.responder_tutor + blueprints/tu_tutor.py):…, _sembrar_tema(), test_contexto_de_pagina_pasa_la_pregunta_en_pantalla(), test_contexto_personal_del_usuario_se_incluye_en_el_prompt(), test_contexto_personal_incluye_la_nota_del_ultimo_test(), test_conversacion_normal_si_conserva_el_historial(), test_dato_verificado_con_pregunta_en_pantalla_no_invierte_opcion_con_doble_negacion() (+36 more)

### Community 15 - ".register"
Cohesion: 0.07
Nodes (10): cancelPendingSurvey(), canRenderSurveyAsync(), Ga, getSurveys(), overrideLinkedFlag(), overrideSampling(), overrideTrigger(), setElementSelectors() (+2 more)
...
Cohesion: 0.07
Nodes (55): _bucket_uso(), cargar_limites_config(), _clave_periodo(), _config_tool(), devolver_uso(), _estructura_defecto(), _fusionar_overrides(), guardar_limites_config() (+47 more)

### Community 18 - "admin/script.js"
Cohesion: 0.05
Nodes (112): abrirModal(), abrirUsuario(), activarPestana(), actualizarBadgeBoe(), actualizarBadgeReportes(), _actualizarBadgesReportesDesglose(), _actualizarStatBoe(), alternarSubmenuSidebar() (+104 more)

### Community 19 - "N"
Cohesion: 0.07
Nodes (10): bn(), cn(), _e(), fn(), Lo, mn(), N(), On (+2 more)
...
Cohesion: 0.10
Nodes (35): _actualizar_resumen_si_hace_falta(), _bloque_explicar_fallo(), _bloque_respuesta_verificada(), _contexto_personal_usuario(), _es_modo_examen(), _es_pregunta_de_test(), _hace_cuanto(), _historial_previo() (+27 more)

### Community 23 - "test_prueba_gratuita.py"
Cohesion: 0.07
Nodes (46): es_dominio_email_desechable(), Dominios de correo desechable/temporal conocidos: una cuenta creada con uno de…, True si el dominio del email está en la lista conocida de correo…, fixture, conectar_firestore(), main(), migrar(), Migración única: antes de este cambio existía un plan "gratis" permanente;… (+38 more)

### Community 24 - "test_documentos_pdf.py"
Cohesion: 0.03
Nodes (75): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), _banco_atascado(), buscar_documento_por_texto(), crear_carpeta() (+67 more)
...
Cohesion: 0.09
Nodes (25): obtener_identidad_desde_token(), obtener_uid_desde_token(), Verifica el Firebase ID token del header Authorization: Bearer <token>.…, Compatibilidad: (uid, email) verificados o None., enviar_verificacion_email(), route, Rutas de autenticación relacionadas con correos que Firebase mandaría por su…, Genera el enlace de restablecimiento de contraseña con Firebase Admin y lo… (+17 more)
...
Cohesion: 0.06
Nodes (54): actualizar_banco_fallos(), listar_fallos(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, desmarcar_favorita(), listar_favoritas(), marcar_favorita(), marcar_repasadas(), Banco persistente de "preguntas favoritas" marcadas por el usuario para repasar… (+46 more)
...
### Community 60 - "q"
Cohesion: 0.07
Nodes (41): s(), l(), allowedMetrics(), as(), Bs(), Bt(), cs(), d() (+33 more)
...
### Community 62 - "generacion_control.py"
Cohesion: 0.20
Nodes (19): _clave(), desregistrar(), Control de parada para generaciones en segundo plano (resumen, esquema, test,…, Crea (o reinicia, si por lo que sea quedó uno viejo sin desregistrar) el evento…, Se llama SIEMPRE al terminar (con éxito, con error, o porque se pidió parar) --…, Marca el evento de parada de esta generación, si sigue en curso. Devuelve True…, Marca la parada de TODAS las generaciones en curso de un usuario, sin necesitar…, registrar() (+11 more)
...
### Community 73 - "deepseek_utils.py"
Cohesion: 0.14
Nodes (17): _generar_documento_validado(), Envoltorio de generar_documento_largo_por_partes que, si el resultado no supera…, call_deepseek_api_stream(), _es_error_transitorio(), generar_documento_largo_por_partes(), _post_deepseek_con_reintentos(), model por defecto "deepseek-v4-flash" (ver call_deepseek_api). Con…, Verifica que la configuración de DeepSeek esté correcta (+9 more)
...
Cohesion: 0.11
Nodes (27): _clave_cron_valida(), enviar_recordatorios_activacion(), enviar_recordatorios_prueba(), enviar_recordatorios_racha(), _guardia_diaria(), route, Tareas activadas por un cron externo (GitHub Actions), no por un usuario --…, Avisa por email del final de la prueba gratuita Premium (planes.py): 2 días… (+19 more)

### Community 77 - "_respuesta_csv"
Cohesion: 0.14
Nodes (14): _celda_csv_segura(), _filas_ingresos(), ingresos_export(), Genera un CSV descargable (UTF-8 con BOM para que Excel respete los acentos)., Todos los usuarios ya decorados (plan efectivo, % de uso, oposiciones…, Descarga todos los usuarios (con los filtros aplicados) en CSV., Una fila por cada oposición que un usuario ha activado alguna vez, con su…, Descarga el detalle de clientes (con los filtros aplicados) en CSV. (+6 more)

### Community 78 - "test_resultado_test_oficial.py"
Cohesion: 0.11
...
### Community 122 - "/assets/plan.js"
Cohesion: 0.15
Nodes (13): /assets/auth.js, /assets/firebase-config.js, MAX_PAGINAS_POR_PLAN, NOMBRE_PLAN, atributosEnlace(), cargarAvisos(), elCargando, elLista (+5 more)
...
### Community 131 - "staleness-deep.mjs"
Cohesion: 0.21
...
### Community 203 - "tu_tutor.py"
Cohesion: 0.19
Nodes (18): eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), route, Tu Tutor: chat conversacional unificado (antes eran dos herramientas separadas…, Recomendación proactiva para el saludo de bienvenida del chat. Es determinista…, tu_tutor_route(), tu_tutor_stream_route() (+10 more)
...
### Community 205 - "resolveProjectRoot"
Cohesion: 0.15
Nodes (24): resolveProjectRoot(), coerceSlug(), listSnapshotsForSlug(), main(), nowFilenameStamp(), parseFrontmatter(), readLatestSnapshot(), readTrend() (+16 more)
...
### Community 211 - "test_autosave_resume.py"
Cohesion: 0.22
...
### Community 232 - "test_promociones.py"
Cohesion: 0.23
Nodes (13): leer_promocion(), promocion_vigente(), Lectura de la promoción/descuento activo -- compartido entre…, Activa Y, si tiene fecha de fin, que todavía no haya pasado. Falla CERRADO ante…, Pruebas de promociones.py: decide si el descuento activo se aplica de verdad en…, test_leer_promocion_lee_lo_guardado(), test_leer_promocion_valores_por_defecto_sin_documento(), test_promocion_activa_con_fecha_fin_futura_esta_vigente() (+5 more)
...
### Community 247 - "obtener_tests_en_progreso_por_documento"
Cohesion: 0.39
...
Cohesion: 0.07
Nodes (50): _bajas_agregadas(), _fallos_agregados(), Agrega el banco de falladas de TODOS los usuarios (collection_group) -- solo…, Agrega los motivos de baja de TODOS los usuarios (collection_group) -- por…, _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking() (+42 more)

### Community 309 - "_bloques_estructurales"
Cohesion: 0.36
...
### Community 314 - "renderGroupedTemplate"
Cohesion: 0.32
...
### Community 324 - "test_preguntas_favoritas.py"
Cohesion: 0.25
Nodes (7): Pruebas de marcar/desmarcar preguntas como favoritas y de generar un test a…, test_desmarcar_favorita(), test_favoritas_no_se_mezclan_entre_oposiciones(), test_generar_test_favoritas_filtra_por_tema(), test_generar_test_favoritas_sin_favoritas_avisa(), test_marcar_dos_veces_no_duplica(), test_marcar_y_listar_favorita()
...
### Community 338 - "g"
Cohesion: 0.08
Nodes (32): addExceptionStep(), b(), constructor(), Fo, g(), getAllFeatureFlags(), getElementSelectors(), getFeatureFlag() (+24 more)

### Community 340 - "checkElementGptBorderShadow"
Cohesion: 0.38
Nodes (7): borderColorsFromStyle(), borderWidthsFromStyle(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM(), checkGptThinBorderWideShadow(), shadowLayerAlpha(), shadowMaxBlurPx()
...
### Community 342 - "test_contadores_preguntas.py"
Cohesion: 0.29
...
### Community 351 - "migrar_usuarios_premium_existente.py"
Cohesion: 0.60
...
## Knowledge Gaps
- **945 isolated node(s):** `tabLogin`, `tabSignup`, `form`, `btnSubmit`, `mensajeError` (+940 more)
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `al`, `concept-seed.mjs`, `po`, `g`, `N`, `De`, `q`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `TestGenerarDocumentoLargoPorPartes` connect `TestGenerarDocumentoLargoPorPartes` to `call_deepseek_api`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `registrar_error_generacion`, `pdf_ia.py`, `test_ia.py`, `test_generador_preguntas_verificado.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `tarjetas_generator.py`, `generador_preguntas_verificado.py`, `coleccion_examenes_oficiales`, `_fragmentos_por_lote`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `deepseek_utils.py`, `_guardar_turno`, `generar_propuesta_cambio`, `TestGeneracionEnLote`, `cargar_temario_boe.py`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
...
- **What connects `tabLogin`, `tabSignup`, `form` to the rest of the system?**
...
- **Should `posthog-array.js` be split into smaller, more focused modules?**
  _Cohesion score 0.025590955806783146 - nodes in this community are weakly interconnected._