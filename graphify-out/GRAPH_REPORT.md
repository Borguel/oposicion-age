...
## Corpus Check
- 443 files · ~1,555,395 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8113 nodes · 18562 edges · 350 communities (311 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 429 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ed8485a6`
...
## Communities (350 total, 39 thin omitted)
...
Cohesion: 0.03
Nodes (81): addFeatureFlagsHandler(), ba, Bo(), Br, Bs(), Ca(), captureException(), captureLog() (+73 more)

### Community 3 - "ya"
Cohesion: 0.04
Nodes (26): canRenderSurvey(), clearCache(), cn(), critical(), destroy(), displaySurvey(), flushLogs(), ge() (+18 more)

### Community 4 - "email_utils.py"
Cohesion: 0.12
Nodes (37): _aviso(), _boton(), _enviar(), enviar_email_activar_oposicion(), enviar_email_alerta_cancelacion_stripe_fallida(), enviar_email_alerta_coste_ia(), enviar_email_alerta_nuevo_usuario(), enviar_email_aviso_oficial() (+29 more)
...
Cohesion: 0.06
Nodes (58): chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion(), documento_banco_preguntas(), documento_banco_tarjetas(), documento_carpeta(), documento_esquema() (+50 more)

### Community 7 - "admin.py"
Cohesion: 0.07
Nodes (89): Exige que quien llama tenga AL MENOS UNO de los permisos indicados (o sea…, requiere_permiso(), analitica_contenido(), avisos_oficiales_crear(), avisos_oficiales_editar(), avisos_oficiales_listar(), _bajas_agregadas(), bajas_listar() (+81 more)
...
Cohesion: 0.07
Nodes (56): responder_tutor(), _eventos_sse(), Pruebas de Tu Tutor (chat_controller.responder_tutor + blueprints/tu_tutor.py):…, _sembrar_tema(), test_contexto_de_pagina_pasa_la_pregunta_en_pantalla(), test_contexto_personal_del_usuario_se_incluye_en_el_prompt(), test_contexto_personal_incluye_la_nota_del_ultimo_test(), test_conversacion_normal_si_conserva_el_historial() (+48 more)

### Community 15 - "Ga"
Cohesion: 0.08
Nodes (7): cancelPendingSurvey(), canRenderSurveyAsync(), Ga, getSurveys(), qa(), Va, Wa
...
Cohesion: 0.09
Nodes (46): _bucket_uso(), _clave_periodo(), _config_tool(), devolver_uso(), max_paginas_para_plan(), Límites de uso de las herramientas de IA (PDF -> resumen/esquema/test/…, Sub-contador de `tipo` para la UNIDAD `periodo` ("dia"/"mes") -- ver el…, Comprueba si el usuario puede usar ahora mismo la herramienta `tipo`, sin… (+38 more)
...
### Community 19 - "N"
Cohesion: 0.08
Nodes (13): allowedMetrics(), flushIntervalMilliseconds(), flushToCaptureTimeoutMs(), getFeatureFlagDetails(), getFeatureFlagPayload(), getFeatureFlagResult(), Ks, N() (+5 more)
...
Cohesion: 0.08
Nodes (43): es_dominio_email_desechable(), Dominios de correo desechable/temporal conocidos: una cuenta creada con uno de…, True si el dominio del email está en la lista conocida de correo…, ¿Es ya cliente de pago en ALGUNA oposición (suscripción real, no la prueba…, tiene_plan_de_pago_activo(), activar_oposicion_usuario(), _clave_prueba_gratuita(), inicializar_estadisticas_usuario() (+35 more)

### Community 24 - "test_documentos_pdf.py"
Cohesion: 0.03
Nodes (72): generar_banco_preguntas_desde_pdf(), generar_banco_tarjetas_desde_pdf(), detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), anadir_al_banco() (+64 more)
...
### Community 31 - "deepseek_utils.py"
Cohesion: 0.06
Nodes (36): _volcar_coste_ia(), AcumuladorTokens, acumular_usage(), coste_estimado(), flush_coste(), guardar_coste_directo(), _incrementar_mes(), Contabilidad del gasto en IA (tokens de DeepSeek) por usuario. Cómo funciona: -… (+28 more)
...
### Community 34 - "usuarios_detalle"
Cohesion: 0.07
Nodes (29): _contar_subcoleccion(), _ficha_actividad(), limites_guardar(), limites_obtener(), _notas_lista(), _oposiciones_activas(), _plan_usuario(), Nº de documentos de una subcolección del usuario. Usa la agregación count()… (+21 more)
...
Cohesion: 0.04
Nodes (82): _decodificar_token_admin(), _decodificar_token_peticion(), _permisos_de(), Verifica el token Bearer y devuelve (decoded, None) o (None, respuesta de…, Conjunto de permisos efectivos del token. El super-admin los tiene todos., verify_id_token() con un reintento ante fallos de red al obtener los…, Header Authorization: Bearer <token> ya verificado -- el dict crudo que…, _verificar_id_token() (+74 more)
...
### Community 60 - "requiere_plan"
Cohesion: 0.07
Nodes (50): obtener_oposicion_solicitada(), Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, Lee sobre qué oposición pide contenido la petición actual (query string…, requiere_plan(), ordenar_por_prioridad_repaso(), Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, ordenar_por_prioridad_repaso(), Repaso espaciado para favoritas: al no haber un contador de fallos (el usuario… (+42 more)
...
### Community 67 - "ka"
Cohesion: 0.06
Nodes (22): as(), bn(), cs(), d(), Dn, _e(), Ea(), Ee() (+14 more)
...
### Community 69 - "error"
Cohesion: 0.08
Nodes (14): Bt(), error(), fa(), gs(), ht, isEnabled(), loadIfEnabled(), ma (+6 more)
...
### Community 74 - "requiere_admin"
Cohesion: 0.07
Nodes (29): Exige que quien llama sea administrador (custom claim admin:true en su token de…, requiere_admin(), auditoria_listar(), banner_obtener(), banner_publico(), _invalidar_cache_admin_usuarios(), _leer_banner(), ranking_demo_borrar() (+21 more)
...
### Community 76 - "tareas_programadas.py"
Cohesion: 0.22
Nodes (16): _clave_cron_valida(), enviar_recordatorios_activacion(), enviar_recordatorios_prueba(), enviar_recordatorios_racha(), _guardia_diaria(), Tareas activadas por un cron externo (GitHub Actions), no por un usuario --…, Avisa por email del final de la prueba gratuita Premium (planes.py): 2 días…, Avisa a quien se registró pero nunca llegó a activar ninguna oposición… (+8 more)

### Community 77 - "_respuesta_csv"
Cohesion: 0.11
Nodes (20): _celda_csv_segura(), _filas_ingresos(), ingresos_export(), ingresos_listar(), Genera un CSV descargable (UTF-8 con BOM para que Excel respete los acentos)., Todos los usuarios ya decorados (plan efectivo, % de uso, oposiciones…, Descarga todos los usuarios (con los filtros aplicados) en CSV., Una fila por cada oposición que un usuario ha activado alguna vez, con su… (+12 more)

### Community 78 - "inline-ignores.mjs"
Cohesion: 0.40
...
Cohesion: 0.12
Nodes (25): resolveProjectRoot(), CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getLegacyLiveAnnotationsDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath(), getLegacyLiveSessionsDir() (+17 more)

### Community 95 - "live-server.mjs"
Cohesion: 0.06
Nodes (71): getDesignSidecarPath(), getImpeccableDir(), getLiveAnnotationsDir(), getLiveDir(), assembleLiveBrowserScript(), assertLiveBrowserScriptParts(), LIVE_BROWSER_SCRIPT_PARTS, readLiveBrowserScriptParts() (+63 more)
...
Cohesion: 0.08
Nodes (12): aa(), constructor(), di(), Fo, hi, la(), onConfigChange(), setElementSelectors() (+4 more)

### Community 102 - "obtener_contexto_por_temas_exactos"
Cohesion: 0.47
...
Cohesion: 0.07
Nodes (45): avisos_oficiales(), obtener_oposiciones_disponibles(), obtener_temas_disponibles(), _oposiciones_visibles_para_la_peticion(), progreso_usuario(), route, Rutas de consulta del catálogo de oposiciones y su temario., (ids_visibles, alguna_activada): IDs de OPOSICIONES que debe ver quien hace la… (+37 more)
...
Cohesion: 0.13
Nodes (31): getLiveSessionsDir(), safeSessionId(), collectManualApplyFiles(), manualApplyReplyCommand(), manualApplyResumeHint(), mountFailureAction(), parseArgs(), renderSummary() (+23 more)

### Community 127 - "desactivar_preguntas_gace_ley_derogada.py"
Cohesion: 0.43
...
### Community 132 - "completar_tema_gace_sector_publico.py"
Cohesion: 0.53
...
Cohesion: 0.18
Nodes (19): clearAppliedEntries(), args, buffer, cwd, pageUrlFilter, remaining, createManualEditRoutes(), sendJson() (+11 more)
...
### Community 217 - "verificar_bloque_temas_referenciados"
Cohesion: 0.25
...
Cohesion: 0.14
Nodes (23): resolveTargetSelection(), parseTargetOptions(), parseTargetPath(), TargetArgError, __dirname, ensureServerRunning(), globToRegex(), acceptInstructions() (+15 more)
...
Cohesion: 0.11
Nodes (16): client(), flask_app(), _limpiar_fake_db(), fixture, Configuración compartida de pytest: prepara variables de entorno dummy y…, Pruebas del catálogo de carpetas de Mis Documentos (documentos_pdf.py + rutas…, test_ruta_crear_carpeta_devuelve_error_si_esta_vacio(), test_ruta_crear_y_ver_carpeta_en_mis_documentos() (+8 more)
...
### Community 265 - "db"
Cohesion: 0.15
Nodes (30): requiere_login(), cancelar_suscripcion(), contactar_soporte(), crear_sesion_checkout(), crear_sesion_portal(), _current_period_end(), eliminar_cuenta(), exportar_datos() (+22 more)
...
### Community 268 - "_parsear_tarjetas"
Cohesion: 0.43
...
### Community 291 - "al"
Cohesion: 0.11
Nodes (9): al, Ao, do(), fe(), ja(), po(), so(), ys() (+1 more)
...
### Community 338 - "g"
Cohesion: 0.09
Nodes (27): addExceptionStep(), b(), g(), getAllFeatureFlags(), getElementSelectors(), getFeatureFlag(), getFlagPayloads(), getFlags() (+19 more)

### Community 341 - "test_tarjetas_generator.py"
Cohesion: 0.25
...
Cohesion: 0.07
Nodes (38): cuerpo_json_invalido(), demasiadas_peticiones(), estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz() (+30 more)
...
## Knowledge Gaps
- **945 isolated node(s):** `TIPO_INFO`, `PAGINA_POR_TIPO`, `tests`, `temasPorId`, `graphify` (+940 more)
...
- **Why does `error()` connect `error` to `posthog-array.js`, `ya`, `ka`, `constructor`, `concept-seed.mjs`, `g`, `N`, `De`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `registrar_error_generacion`, `pdf_ia.py`, `test_generador_preguntas_verificado.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `tarjetas_generator.py`, `deepseek_utils.py`, `generador_preguntas_verificado.py`, `coleccion_examenes_oficiales`, `_fragmentos_por_lote`, `requiere_plan`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `generar_propuesta_cambio`, `TestGeneracionEnLote`, `cargar_temario_boe.py`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `usuario_autenticado()` connect `usuario_autenticado` to `test_generar_test_oficial.py`, `sembrar_usuario_activo`, `test_push_notificaciones.py`, `test_guardar_test_con_numeros_del_bug_guarda_suspendido`, `test_generador_preguntas_verificado.py`, `test_verificacion_respuestas_oficiales.py`, `test_tu_tutor.py`, `test_error_handler.py`, `test_temario.py`, `test_prueba_gratuita.py`, `conftest.py`, `test_repaso_espaciado.py`, `test_gestion_cuenta.py`?**
...
- **What connects `TIPO_INFO`, `PAGINA_POR_TIPO`, `tests` to the rest of the system?**
...
- **Should `posthog-array.js` be split into smaller, more focused modules?**
  _Cohesion score 0.028343023255813952 - nodes in this community are weakly interconnected._