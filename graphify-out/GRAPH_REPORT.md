...
## Corpus Check
- 439 files · ~1,538,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7890 nodes · 17960 edges · 339 communities (299 shown, 40 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 436 edges (avg confidence: 0.62)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08314c0b`
...
### Community 6 - "displaySurvey"
Cohesion: 0.33
Nodes (3): canRenderSurvey(), displaySurvey(), renderSurvey()

### Community 7 - "admin.py"
Cohesion: 0.04
Nodes (146): analitica_contenido(), auditoria_listar(), avisos_oficiales_actualizar(), avisos_oficiales_crear(), avisos_oficiales_editar(), avisos_oficiales_listar(), _bajas_agregadas(), bajas_listar() (+138 more)
...
Cohesion: 0.04
Nodes (121): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_admin(), requiere_plan(), % de uso MÁS ALTO entre todas las herramientas del usuario en su periodo…, _uso_pico(), chat_pdf_mensaje(), chat_pdf_mensaje_stream() (+113 more)
...
Cohesion: 0.03
Nodes (87): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_tipo_contenido(), actualizar_titulo(), anadir_al_banco(), _banco_atascado(), _banco_ref() (+79 more)
...
### Community 34 - "staleness-deep.mjs"
Cohesion: 0.21
...
### Community 36 - "test_gestion_cuenta.py"
Cohesion: 0.17
...
### Community 55 - "pagos.py"
Cohesion: 0.03
Nodes (112): estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz(), Sin autenticación a propósito: la usa el monitor externo (GitHub Actions, o el…, verificar_api_key() (+104 more)
...
Cohesion: 0.04
Nodes (83): coleccion_banco_preguntas(), guardar_pregunta_generada(), Repositorio interno de preguntas de Test Personalizado ya generadas y…, Guarda una pregunta de Test Personalizado ya verificada en el banco de esa…, _normalizar_pregunta_pdf(), Deja una pregunta cruda de generar_preguntas_ia_en_lotes/…, activar_oposicion(), avisos_oficiales() (+75 more)
...
### Community 69 - "reasignar_temas_examenes.py"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (24): Revisa el BOE (leyes vigiladas + sumario diario) y deja en Firestore…, vigilar_boe(), _fake_response(), _metadatos(), Pruebas de vigilancia_boe.py: nunca publica/aplica nada sola -- solo crea…, _respuesta_http_error(), _sumario_con_item(), test_clasificar_aviso_llamamiento_extraordinario_no_es_fecha_examen() (+16 more)
...
### Community 89 - "readLiveServerInfo"
Cohesion: 0.39
...
Cohesion: 0.07
Nodes (66): assembleLiveBrowserScript(), assertLiveBrowserScriptParts(), LIVE_BROWSER_SCRIPT_PARTS, readLiveBrowserScriptParts(), resolveLiveBrowserScriptParts(), acknowledgePendingEvent(), activeSessionSummaries(), agentPollingConnected() (+58 more)
...
### Community 105 - "ranking.py"
Cohesion: 0.39
Nodes (7): _alias_valido(), mi_estado_ranking(), obtener_ranking(), route, Clasificación de racha de estudio: anónima y estrictamente opcional. Solo…, salir_ranking(), unirse_ranking()
...
Cohesion: 0.09
Nodes (23): main(), Sube a Firestore los datos oficiales de la convocatoria vigente de una…, aplicar(), doc_ids(), _firestore_client(), main(), preview(), Desactiva en Firestore las preguntas del banco de GACE que preguntan… (+15 more)
...
Cohesion: 0.07
Nodes (56): collectUnusedSelectors(), verifyAcceptedSource(), applyLegacyDeferredAcceptsOnStartup(), buildPropsScriptV2(), loadSvelteCompiler(), appendCssToSvelteStyle(), appendSanitizedCssRule(), applyDeferredSvelteComponentAccepts() (+48 more)
...
### Community 126 - "expandScanTargets"
Cohesion: 0.36
...
### Community 127 - "sugerencia_inicial_usuario"
Cohesion: 0.40
...
Cohesion: 0.28
Nodes (13): resolveProjectRoot(), getLegacyLiveAnnotationsDir(), getLegacyLiveServerPath(), getSurfaceBriefDir(), listSurfaceBriefs(), normalizeSurfaceTarget(), parseSurfaceBrief(), resolveSurfaceBrief() (+5 more)
...
Cohesion: 0.20
Nodes (16): CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveConfigPath(), getLiveAnnotationsDir(), getLiveConfigPath() (+8 more)
...
### Community 248 - "normalizeGitHubEvent"
Cohesion: 0.38
...
### Community 284 - "rutas_progreso.py"
Cohesion: 0.06
Nodes (47): actualizar_banco_fallos(), _id_pregunta(), listar_fallos(), ordenar_por_prioridad_repaso(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, desmarcar_favorita(), _id_pregunta() (+39 more)
...
### Community 302 - "propagar_proxy_saliente"
Cohesion: 0.36
...
- **Why does `error()` connect `ya` to `posthog-array.js`, `concept-seed.mjs`, `al`, `warn`, `ka`, `N`, `po`, `De`, `g`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `registrar_error_generacion`, `test_generador_preguntas_verificado.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `pdf_ia.py`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `tarjetas_generator.py`, `generador_preguntas_verificado.py`, `test_test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `deepseek_utils.py`, `generar_propuesta_cambio`, `test_generator.py`, `TestGeneracionEnLote`, `cargar_temario_boe.py`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `usuario_autenticado()` connect `usuario_autenticado` to `test_generar_test_oficial.py`, `test_gestion_cuenta.py`, `conftest.py`, `sembrar_usuario_activo`, `test_generador_preguntas_verificado.py`, `push_utils.py`, `test_resultado_test_oficial.py`, `test_repaso_espaciado.py`, `test_tu_tutor.py`, `test_verificacion_respuestas_oficiales.py`, `test_temario.py`, `pagos.py`, `rutas_progreso.py`?**
...
- **Should `test_admin.py` be split into smaller, more focused modules?**
  _Cohesion score 0.027852004110996916 - nodes in this community are weakly interconnected._
