...
## Corpus Check
- 443 files · ~1,557,342 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8126 nodes · 18579 edges · 360 communities (319 shown, 41 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 441 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7703fea1`
...
Cohesion: 0.14
Nodes (48): Exige que quien llama sea administrador (custom claim admin:true en su token de…, Exige que el usuario tenga, como mínimo, el plan `minimo`. Por defecto…, requiere_admin(), requiere_plan(), chat_pdf_mensaje(), chat_pdf_mensaje_stream(), crear_carpeta_documentos(), detener_generacion() (+40 more)

### Community 7 - "admin.py"
Cohesion: 0.05
Nodes (112): analitica_contenido(), auditoria_listar(), avisos_oficiales_actualizar(), avisos_oficiales_crear(), avisos_oficiales_editar(), avisos_oficiales_listar(), bajas_listar(), banco_preguntas_resumen() (+104 more)
...
Cohesion: 0.09
Nodes (49): responder_tutor(), _eventos_sse(), Pruebas de Tu Tutor (chat_controller.responder_tutor + blueprints/tu_tutor.py):…, _sembrar_tema(), test_contexto_de_pagina_pasa_la_pregunta_en_pantalla(), test_contexto_personal_del_usuario_se_incluye_en_el_prompt(), test_contexto_personal_incluye_la_nota_del_ultimo_test(), test_conversacion_normal_si_conserva_el_historial() (+41 more)

### Community 15 - ".register"
Cohesion: 0.06
Nodes (11): cancelPendingSurvey(), canRenderSurveyAsync(), Ga, getSurveys(), overrideLinkedFlag(), overrideSampling(), overrideTrigger(), qa() (+3 more)
...
Cohesion: 0.05
Nodes (44): activarPestana(), alternarSubmenuSidebar(), atraparTabEnModal(), bloquesAbiertos, bloquesAbiertosPreguntas, cerrarSidebar(), descargarCSV(), _EJEMPLO_IMPORT (+36 more)

### Community 19 - "N"
Cohesion: 0.07
Nodes (6): bn(), critical(), destroy(), fn(), N(), On
...
Cohesion: 0.05
Nodes (73): _permisos_de(), Conjunto de permisos efectivos del token. El super-admin los tiene todos., Exige que quien llama tenga AL MENOS UNO de los permisos indicados (o sea…, requiere_permiso(), es_dominio_email_desechable(), Dominios de correo desechable/temporal conocidos: una cuenta creada con uno de…, True si el dominio del email está en la lista conocida de correo…, enviar_email_alerta_nuevo_usuario() (+65 more)

### Community 24 - "test_documentos_pdf.py"
Cohesion: 0.05
Nodes (59): detectar_texto_legal(), True si 'texto' tiene pinta de ser una ley/reglamento/BOE (en cuyo caso…, actualizar_progreso_generacion(), actualizar_titulo(), _banco_atascado(), buscar_documento_por_texto(), crear_documento(), eliminar_documento() (+51 more)
...
Cohesion: 0.09
Nodes (25): _decodificar_token_admin(), _decodificar_token_peticion(), obtener_identidad_desde_token(), obtener_uid_desde_token(), Verifica el token Bearer y devuelve (decoded, None) o (None, respuesta de…, verify_id_token() con un reintento ante fallos de red al obtener los…, Header Authorization: Bearer <token> ya verificado -- el dict crudo que…, Verifica el Firebase ID token del header Authorization: Bearer <token>.… (+17 more)
...
Cohesion: 0.10
Nodes (11): clampPlaceholderSize(), computeInsertPosition(), groupSiblingRows(), hitSiblingInsertGap(), horizontalOverlap(), insertLineCoords(), PLACEHOLDER_DEFAULT_HEIGHT, PLACEHOLDER_MIN_HEIGHT (+3 more)

### Community 34 - "detect-html.mjs"
Cohesion: 0.07
...
### Community 36 - "guardar_resultado.py"
Cohesion: 0.06
Nodes (47): actualizar_banco_fallos(), listar_fallos(), ordenar_por_prioridad_repaso(), Banco persistente de "preguntas falladas" por usuario/oposición. Antes, el test…, Repaso espaciado simple: en vez de elegir al azar entre las preguntas falladas…, desmarcar_favorita(), listar_favoritas(), marcar_favorita() (+39 more)
...
Cohesion: 0.06
Nodes (50): Mockea auth_utils.firebase_auth.verify_id_token para simular una sesión…, usuario_autenticado(), _mock_precio(), Pruebas de las rutas que crean sesiones de pago en Stripe (/crear-sesion-…, test_cancelar_suscripcion_con_subscription_id_huerfano_se_marca_gratis_localmente(), test_cancelar_suscripcion_error_de_stripe_da_500_sin_filtrar_el_mensaje_crudo(), test_cancelar_suscripcion_no_marca_gratis_si_el_error_no_es_resource_missing(), test_cancelar_suscripcion_programa_la_baja_y_guarda_el_motivo() (+42 more)
...
### Community 67 - "ranking.py"
Cohesion: 0.22
Nodes (13): ranking_demo_sembrar(), Crea (o sobrescribe, si ya existían) los 30 participantes de demostración de…, _alias_valido(), mi_estado_ranking(), obtener_ranking(), _participantes_ranking(), route, Clasificación de racha de estudio: anónima y estrictamente opcional. Solo… (+5 more)
...
### Community 74 - "q"
Cohesion: 0.07
Nodes (30): s(), allowedMetrics(), Bs(), Bt(), f(), fa(), flushIntervalMilliseconds(), flushToCaptureTimeoutMs() (+22 more)
...
### Community 76 - "staleness-deep.mjs"
Cohesion: 0.21
...
Cohesion: 0.13
Nodes (29): actualizar_estadisticas_esquema(), actualizar_estadisticas_test(), Deshace en estadisticas.{oposicion} la contribución de UN test ya guardado (ver…, revertir_estadisticas_test(), conectar_firestore(), corregir(), main(), Corrección única: el campo "resultado" (aprobado/suspendido) de un test se… (+21 more)
...
Cohesion: 0.06
Nodes (59): enviar_email_alerta_cancelacion_stripe_fallida(), Aviso interno (no es un email de marca para un usuario) de que no se pudo…, _clave(), desregistrar(), Control de parada para generaciones en segundo plano (resumen, esquema, test,…, Crea (o reinicia, si por lo que sea quedó uno viejo sin desregistrar) el evento…, Se llama SIEMPRE al terminar (con éxito, con error, o porque se pidió parar) --…, Marca el evento de parada de esta generación, si sigue en curso. Devuelve True… (+51 more)

### Community 94 - "push_utils.py"
Cohesion: 0.18
Nodes (17): _b64url_decode(), borrar_suscripcion(), _cifrar_aes128gcm(), _clave_privada_vapid(), enviar_push(), guardar_suscripcion(), _hkdf_expand(), _hkdf_extract() (+9 more)
...
Cohesion: 0.25
Nodes (17): actualizarBadgeReportes(), _actualizarBadgesReportesDesglose(), apiGet(), cargarAuditoria(), cargarErroresIA(), cargarIngresos(), cargarReportes(), cargarSoporte() (+9 more)
...
### Community 102 - "ka"
Cohesion: 0.06
Nodes (25): as(), Ca(), cs(), Dn, ds(), Ea(), ensureFlagsLoaded(), fs() (+17 more)
...
Cohesion: 0.20
Nodes (22): api(), buscarYEditarPregunta(), cambiarEstadoAvisoOficial(), cambiarEstadoCambioTemario(), cambiarEstadoReporte(), cambiarEstadoSoporte(), cargarChunks(), cargarPreguntas() (+14 more)
...
Cohesion: 0.27
Nodes (18): abrirModal(), abrirUsuario(), cargarUsuarios(), cerrarModal(), confirmarAdmin(), escapeHtml(), fechaCorta(), fichaCosteBarras() (+10 more)
...
### Community 132 - "utils.py"
Cohesion: 0.08
Nodes (41): _bajas_agregadas(), Agrega los motivos de baja de TODOS los usuarios (collection_group) -- por…, activar_oposicion(), avisos_oficiales(), obtener_oposiciones_disponibles(), obtener_temas_disponibles(), _oposiciones_visibles_para_la_peticion(), progreso_usuario() (+33 more)
...
Cohesion: 0.11
Nodes (28): AGENT_PHASE_SET, FORBIDDEN_MANUAL_EDIT_TEXT_CHARS, INSERT_POSITIONS, isValidId(), isValidMountVariant(), isValidVariantId(), MOUNT_ERROR_MAX_LENGTH, MOUNT_URL_MAX_LENGTH (+20 more)
...
### Community 247 - "tu_tutor.py"
Cohesion: 0.23
Nodes (11): eliminar_conversacion(), obtener_conversacion(), obtener_conversaciones_usuario(), limit, route, Tu Tutor: chat conversacional unificado (antes eran dos herramientas separadas…, Recomendación proactiva para el saludo de bienvenida del chat. Es determinista…, tu_tutor_route() (+3 more)
...
### Community 250 - "resolver_tipo_contenido"
Cohesion: 0.22
...
### Community 253 - "reasignar_temas_examenes.py"
Cohesion: 0.22
...
Cohesion: 0.18
Nodes (25): requiere_login(), cancelar_suscripcion(), contactar_soporte(), crear_sesion_checkout(), crear_sesion_portal(), _current_period_end(), eliminar_cuenta(), exportar_datos() (+17 more)
...
### Community 317 - "app.py"
Cohesion: 0.14
Nodes (18): cuerpo_json_invalido(), demasiadas_peticiones(), estado_salud(), fichero_demasiado_grande(), manejar_error_no_controlado(), limit, route, raiz() (+10 more)

### Community 318 - "bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 319 - "_recortar_a_bytes_utf8"
Cohesion: 0.27
...
### Community 335 - "_generar_pregunta_verificada"
Cohesion: 0.33
...
### Community 336 - "_contiene_frase_prohibida"
Cohesion: 0.31
...
### Community 338 - "g"
Cohesion: 0.08
Nodes (29): addExceptionStep(), Ce(), constructor(), count(), ct(), d(), _e(), Ee() (+21 more)

### Community 340 - "preguntas_listar"
Cohesion: 0.25
...
### Community 349 - "checkElementGptBorderShadow"
Cohesion: 0.38
Nodes (7): borderColorsFromStyle(), borderWidthsFromStyle(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM(), checkGptThinBorderWideShadow(), shadowLayerAlpha(), shadowMaxBlurPx()
...
### Community 352 - "firebase_setup.py"
Cohesion: 0.20
...
### Community 353 - "completar_tema_gace_sector_publico.py"
Cohesion: 0.53
...
- **Why does `error()` connect `g` to `posthog-array.js`, `ya`, `concept-seed.mjs`, `ka`, `q`, `N`, `De`, `po`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `generar_preguntas_ia_en_lotes()` connect `TestGenerarPreguntasIaEnLotes` to `pdf_ia.py`, `call_deepseek_api`, `test_validador_preguntas.py`, `_detectar_duplicados_finales`, `test_generador_ia_temario.py`, `generar_banco_preguntas_adaptativo`, `_fragmentos_por_lote`, `test_generator.py`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `call_deepseek_api()` connect `call_deepseek_api` to `pdf_ia.py`, `test_ia.py`, `test_tu_tutor.py`, `_detectar_duplicados_finales`, `TestGenerarPreguntasIaEnLotes`, `chat_controller.py`, `regenerar_temario_ofimatica.py`, `tarjetas_generator.py`, `generador_preguntas_verificado.py`, `coleccion_examenes_oficiales`, `_fragmentos_por_lote`, `test_generator.py`, `vigilancia_boe.py`, `cargar_temario_auxiliar.py`, `cargar_temario_metro.py`, `deepseek_utils.py`, `_generar_pregunta_verificada`, `generar_propuesta_cambio`, `_guardar_turno`, `TestGeneracionEnLote`, `cargar_temario_boe.py`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
...
- **Should `posthog-array.js` be split into smaller, more focused modules?**
  _Cohesion score 0.02749515503875969 - nodes in this community are weakly interconnected._